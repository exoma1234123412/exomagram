-- ============================================
-- EXOMAGRAM V3 - Trust Score History & Improvements
-- ============================================

-- ============================================
-- TRUST SCORE HISTORY - Track scores over time
-- ============================================
...
ALTER PUBLICATION supabase_realtime ADD TABLE trust_score_history;
