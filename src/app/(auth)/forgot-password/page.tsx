...
export default function ForgotPasswordPage() {
 ...
 <div className="bg-emerald-500/5 border border-emerald-500/20 px-3 py-4 text-center space-y-2">
 ...
 <Link href="/login">
 <Button
 variant="outline"className="w-full h-10 font-medium mt-2">
 ...
 >
 {loading
 ?"Enviando...":"Enviar enlace de recuperación"}
 </Button>
 </form>
