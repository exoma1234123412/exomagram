      ...
      <path
        ...
        className={
          points[points.length - 1].score >= 75
            ? "text-green-500"
            : points[points.length - 1].score >= 50
              ? "text-yellow-500"
              : "text-red-500"
        }
      />
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
      ...
      <section className="mb-8">
        ...
        {/* Identity card */}
        <Card className="transition-all duration-300 hover:shadow-lg hover:shadow-primary/5 mb-4">
      ...
      <section className="mb-8">
        ...
        <Card className="transition-all duration-300 hover:shadow-lg hover:shadow-primary/5 border-red-200/50 dark:border-red-900/50">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="flex items-center gap-3 flex-wrap">
                  ...
                  <div className="inline-flex items-center gap-1 bg-accent/60 rounded-lg px-2 py-0.5">
                    ...
                    <input
                      ...
                      className="w-14 bg-transparent text-sm font-bold tabular-nums text-center outline-none"
                      min={1}
                    />
                    <span className="text-xs text-muted-foreground">
                      /hora
      ...
      <section className="mb-8">
        ...
        <div className="space-y-3">
          ...
          {computed.proofRate < 100 && (
            <Card className="transition-all duration-300 hover:shadow-lg hover:shadow-primary/5 hover:-translate-y-0.5">
              <CardContent className="p-4">
                <div className="flex items-center gap-4">
                  ...
                  <Link href="/dashboard">
                    <Button
                      size="sm"
                      className="rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 text-white border-0 shadow-lg shadow-blue-600/25 gap-1"
                    >
                      Registrar
          ...
          {data.suspiciousReactions.length > 0 && (
            <Card className="transition-all duration-300 hover:shadow-lg hover:shadow-primary/5 hover:-translate-y-0.5 border-orange-200 dark:border-orange-900">
              <CardContent className="p-4">
                <div className="flex items-center gap-4">
