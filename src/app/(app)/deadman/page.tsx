...
export default function DeadmanPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
                      ...
                      <div className="text-right flex flex-col items-end gap-3">
                        ...
                        {member.userId !== userId && (
                          <Button
                            ...
                            size="sm"
                            className="bg-primary text-primary-foreground font-mono text-xs border-0"
                          >
      ...
      <div className="mb-8">
        <h2 className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground/40 mb-4 flex items-center gap-2">
