...
"font-mono text-[9px] uppercase font-bold tracking-wider",
 ...
 <p className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground mb-1 flex items-center gap-1">
 ...
 className="flex items-center gap-1 font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground mb-1.5 cursor-pointer hover:text-foreground transition-colors">
...
export default function ResignRiskPage() {
 ...
 <p className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground mt-0.5">
 ...
 <p className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground">Analizados</p>
 </div>
 ...
 <p className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground">Criticos</p>
 </div>
 ...
 <p className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground">Riesgo alto</p>
 </div>
 <div className="bg-accent/30 border border-border p-3 text-center">
 <p className="font-mono text-sm font-bold tabular-nums tracking-tight">{results.analysis_date}</p>
 <p className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground">Fecha</p>
 </div>
 </div>
 ...
 <span className="font-mono text-[9px] text-muted-foreground">(ordenado por riesgo)</span>
 </div>
