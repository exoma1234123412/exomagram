      ...
      {members.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-16 gap-4">
          <div className="w-16 h-16 border border-border flex items-center justify-center">
            <Skull className="w-7 h-7 text-muted-foreground/30" />
          </div>
        ...
        <div className="space-y-2">
          {members.map((m, idx) => {
            ...
            const rankClass = cn(
              ...
              isLow && "text-sm text-muted-foreground/40",
              ...
              <div key={m.userId} className={cn(borderClass, paddingClass)}>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    >
                      {isExpanded ? (
                        <ChevronUp className="w-3 h-3 text-muted-foreground/40 group-hover:text-muted-foreground" />
                      ) : (
                        <ChevronDown className="w-3 h-3 text-muted-foreground/40 group-hover:text-muted-foreground" />
                      )}
                      <span className="font-mono text-[9px] text-muted-foreground/40 group-hover:text-muted-foreground tracking-wider uppercase">
                  ...
                  <div className="text-right shrink-0">
                    ...
                    <p className="font-mono text-[9px] tracking-[0.12em] uppercase text-muted-foreground/40">
                      pts
                    </p>
                  </div>
                </div>
...
function BreakdownItem({
  ...
  return (
    <div className="bg-accent/20 border border-border p-2">
      <p className="font-mono text-[8px] tracking-[0.12em] uppercase text-muted-foreground/40">
        {label}
      </p>
      ...
      <p className="font-mono text-[7px] text-muted-foreground/30 mt-0.5">
        {rate}
      </p>
    </div>
  );
