...
export default function RetentionPage() {
 ...
 <div className="bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-800/40 px-4 py-3 mb-6 flex items-center gap-3">
 ...
 className="gap-2 bg-primary hover:from-blue-700 hover:to-blue-800 text-white border-0">
 {loading ? (
 <>
 ...
 {data.highest_risk && (
 <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800/40 px-4 py-3 flex items-start gap-3">
...
"h-full rounded-full transition-all duration-500",
 ...
 <Badge
 key={si}
 variant="outline"className="text-[10px] font-normal">
 {signal}
 </Badge>
 ))}
 </div>
 ...
 <div className="bg-accent/40 px-3 py-2.5">
