...
export default function EntropyPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
      ...
      {members.length === 0 ? (
        ...
        <div className="space-y-4">
          {members.map((m) => {
            ...
            return (
              <Card key={m.profile.id} className="transition-all duration-300 hover:shadow-lg hover:shadow-primary/5">
                      ...
                      {m.days.map((d) => {
                        ...
                        return (
                          <div
                            ...
                            title={`${dateLabel}: ${d.entries > 1 ? (d.entropy * 100).toFixed(0) + "%" : "sin datos"} (${d.entries} entradas)`}
                          >
                            <div
                              className={cn(
      ...
      {/* Legend */}
      <div className="mt-8 p-4 bg-accent/40 rounded-xl">
