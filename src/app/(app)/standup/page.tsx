...
export default function StandupPage() {
 ...
 <Textarea
 placeholder="Resumen de lo que lograste ayer..."value={yesterday}
 ...
 <Textarea
 placeholder="Plan para hoy, sé específico..."value={todayPlan}
 ...
 <Textarea
 placeholder="¿Algo que necesitas de alguien más? ¿Algo que te impide avanzar?"value={blockers}
