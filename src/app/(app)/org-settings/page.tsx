...
export default function OrgSettingsPage() {
 ...
 disabled={saving}
 className="gap-1.5 bg-primary hover:from-blue-700 hover:to-blue-800 text-white">
 {saving ? (
"Guardando...") : saved ? (
 <>
 ...
 <TabsTrigger
 value="accountability"className="gap-1.5 text-xs sm:text-sm">
 <Shield className="w-3.5 h-3.5"/>
 Reglas
 </TabsTrigger>
 <TabsTrigger
 value="notifications"className="gap-1.5 text-xs sm:text-sm">
 ...
 <Input
 id="orgName"value={settings.orgName}
...
"slug",
 ...
 placeholder="acme-corp"className="font-mono text-sm"/>
 ...
 alt="Logo"className="w-10 h-10 object-cover border"onError={(e) => {
 (e.target as HTMLImageElement).style.display ="none";
 }}
 />
 )}
 <Input
 id="logoUrl"value={settings.logoUrl}
 onChange={(e) => update("logoUrl", e.target.value)}
 placeholder="https://example.com/logo.png"className="flex-1"/>
 </div>
 </div>
 ...
 <Input
 id="description"value={settings.description}
 ...
 <div className="flex items-center gap-3">
 <Input
 id="expectedDailyHours"type="number"min={1}
 max={12}
...
"Todas las entradas deben incluir evidencia"}
 ...
 <div className="flex items-center gap-3">
 <Input
 id="maxBackfill"type="number"min={0}
 max={168}
...
"text-sm font-medium text-right",
 ...
 <div
 className="bg-blue-500"style={{ width:`${settings.trustWeightHours}%`}}
 title={`Horas: ${settings.trustWeightHours}%`}
 />
 <div
 className="bg-green-500"style={{ width:`${settings.trustWeightProof}%`}}
 title={`Evidencia: ${settings.trustWeightProof}%`}
 />
 <div
 className="bg-purple-500"style={{ width:`${settings.trustWeightCloseout}%`}}
 title={`Cierre: ${settings.trustWeightCloseout}%`}
 />
 <div
 className="bg-amber-500"style={{ width:`${settings.trustWeightLatePenalty}%`}}
 title={`Tardanza: ${settings.trustWeightLatePenalty}%`}
 />
 <div
 className="bg-red-500"style={{ width:`${settings.trustWeightSuspiciousPenalty}%`}}
 ...
 <Input
 id="slackWebhook"value={settings.slackWebhookUrl}
 onChange={(e) => update("slackWebhookUrl", e.target.value)}
 placeholder="https://hooks.slack.com/services/..."className="font-mono text-sm"/>
 <p className="text-xs text-muted-foreground">
 ...
 <Input
 type="time"value={settings.closeoutReminderTime}
 onChange={(e) =>
 ...
 <Button
 variant="outline"onClick={handleExportAll}
 className="gap-1.5">
 ...
 <Input
 placeholder="Email del nuevo owner"value={transferEmail}
 ...
 render={
 <Button
 variant="outline"disabled={!transferEmail.trim()}
 ...
 <Button
 className="bg-amber-600 hover:bg-amber-700 text-white"onClick={() => {
 alert(
`Transferencia a ${transferEmail} registrada. Contacta soporte para completar el proceso.`);
 ...
 {/* Delete organization */}
 <div className="p-4 border border-red-200 dark:border-red-900/50 bg-red-50/50 dark:bg-red-950/10">
 ...
 render={
 <Button
 variant="outline"className="gap-1.5 border-red-300 text-red-700 hover:bg-red-100 dark:border-red-800 dark:text-red-400 dark:hover:bg-red-950"/>
 }
 >
 ...
 <Button
 variant="destructive"disabled={deleteConfirmText !== settings.orgName}
