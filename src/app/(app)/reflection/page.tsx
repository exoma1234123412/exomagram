...
export default function ReflectionPage() {
 ...
 {!isCurrentWeek && (
 <Button
 variant="outline"size="sm"onClick={() => setWeekStart(getWeekStart())}
...
"w-3 h-3 text-muted-foreground transition-transform",
 ...
 placeholder="Describe tu mayor logro..."rows={2}
 ...
 placeholder="Describe tu mayor reto..."rows={2}
 className="font-mono text-xs min-h-[48px]"/>
 </div>
 ...
 placeholder="Que aprendiste esta semana..."rows={2}
 className="font-mono text-xs min-h-[48px]"/>
 </div>
 ...
 placeholder="Si pudieras repetir la semana..."rows={2}
 className="font-mono text-xs min-h-[48px]"/>
 </div>
 ...
 placeholder="Prioridad 1, Prioridad 2, Prioridad 3"className="font-mono text-xs"/>
 </div>
 ...
 placeholder="Comunicacion, liderazgo, tecnico"className="font-mono text-xs"/>
 </div>
 ...
 placeholder="React, SQL, presentaciones"className="font-mono text-xs"/>
 </div>
 ...
 <div className="flex gap-1">
 <button
 type="button"onClick={() => setWouldRecommend(true)}
 className={cn(
"w-8 h-8 border border-border flex items-center justify-center cursor-pointer transition-colors",
 ...
 <button
 type="button"onClick={() => setWouldRecommend(false)}
 className={cn(
"w-8 h-8 border border-border flex items-center justify-center cursor-pointer transition-colors",
 ...
 placeholder="productiva"maxLength={30}
