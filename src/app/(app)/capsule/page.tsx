...
export default function CapsulePage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
      ...
      {/* Week indicator */}
      <div className="bg-accent/40 rounded-xl px-4 py-2.5 mb-6 inline-flex items-center gap-2">
              ...
              >
                <CardContent className="p-5">
                  <div className="flex items-start gap-4">
                    {/* Avatar */}
                    <Avatar className="w-10 h-10 ring-2 ring-background shadow-sm shrink-0">
                      <AvatarImage
