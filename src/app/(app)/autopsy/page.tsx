  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-8">
        <div className="bg-accent/40 rounded-xl p-4 flex flex-col gap-1">
          ...
          <CardContent className="p-4 flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium">
                {trend.direction === "improving"
                  ? "Las reuniones estan mejorando"
                  : trend.direction === "declining"
                    ? "Las reuniones estan empeorando"
                    : "Las reuniones se mantienen estables"}
              </p>
              <p className="text-xs text-muted-foreground">
                {trend.delta !== 0
                  ? `${trend.delta > 0 ? "+" : ""}${trend.delta} puntos vs. las primeras 2 semanas`
                  : "Sin cambio significativo entre las primeras y ultimas 2 semanas"}
              </p>
            </div>
          </CardContent>
        </Card>
