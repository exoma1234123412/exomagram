        ...
        >
          ...
          <div className="flex-1">
            ...
            <p className="text-xs font-mono text-muted-foreground mt-0.5">
              {isMyGhost
                ? `Desaparecido hace ${myStatus.hoursGhost}h. Registra tu actividad para volver a ser visible.`
                : `${myStatus.entriesCount} entradas hoy. Tu presencia es visible para el equipo.`}
            </p>
          </div>
          {isMyGhost && (
          ...
          <div className="space-y-2">
            {ghostHistory
              ...
              .map((entry, i) => (
                ...
                >
                  <Ghost className="w-4 h-4 text-muted-foreground/40 shrink-0" />
    ...
    >
      <CardContent className="flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-3 mt-1">
            <span className="font-mono text-[10px] text-muted-foreground">
              {entriesCount > 0
                ? `Ultima entrada: ${formatHour(lastEntryHour!)}`
                : "Sin entradas hoy"}
            </span>
            {liveStatus && (
        ...
        <div className="text-right shrink-0">
          ...
          <p className="font-mono text-[9px] text-muted-foreground/50 uppercase">
            Fantasma
          </p>
        </div>
      </CardContent>
