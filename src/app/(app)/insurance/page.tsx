...
"w-16 h-16 flex items-center justify-center border",
 todayHasInsurance
 ?"border-emerald-600/30 bg-emerald-500/10":"border-border bg-accent/30")}
 >
 {todayHasInsurance ? (
 ...
 <div
 className="h-full bg-emerald-500 transition-all duration-500"style={{ width:`${protectionPct}%`}}
 />
 </div>
 </CardContent>
 </Card>
 ...
 <div key={d} className="text-center font-mono text-[9px] tracking-wider uppercase text-muted-foreground py-1">
 {d}
 </div>
 ))}
 </div>
...
"font-mono tabular-nums text-[10px]",
 ...
 isPast && !isProtected &&"text-muted-foreground",
 ...
 <DialogFooter>
 <Button
 variant="outline"onClick={() => setConfirmOpen(false)}
