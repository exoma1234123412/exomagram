    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 print:px-8 print:py-4">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 gap-4">
        ...
        <div className="flex items-center gap-2 print:hidden">
          ...
          {!isToday && (
            <Button variant="ghost" size="sm" className="rounded-xl" onClick={goToday}>
              Hoy
            </Button>
          )}
        </div>
      ...
      {loading ? (
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            <Card className="transition-all duration-300 hover:shadow-lg hover:shadow-primary/5">
              <CardContent className="p-5 text-center">
                <div className="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-accent/40 mb-2">
            ...
            <Card className="transition-all duration-300 hover:shadow-lg hover:shadow-primary/5">
              <CardContent className="p-5 text-center">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  {typeof teamMoodAvg === "string" && teamMoodAvg !== "--"
                    ? getMoodEmoji(parseFloat(teamMoodAvg))
                    : ""}{" "}
                  Animo promedio
                </p>
              </CardContent>
          ...
          {mvp && mvp.proofHours > 0 && (
            <Card className="transition-all duration-300 hover:shadow-lg hover:shadow-primary/5 border-yellow-300/60 dark:border-yellow-700/40 shadow-xl shadow-yellow-500/10 ring-1 ring-yellow-300/30 overflow-hidden">
              <CardContent className="p-6">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-6">
                  ...
                  <div className="relative">
                    <Avatar className="w-20 h-20 ring-4 ring-yellow-200 dark:ring-yellow-800 shadow-lg">
                      <AvatarImage
                  ...
                  <div className="flex-1 text-center sm:text-left">
                    ...
                    <div className="flex flex-wrap items-center justify-center sm:justify-start gap-3 mt-3">
                      <div className="bg-accent/40 rounded-xl px-3 py-1.5 text-center">
          ...
          {/* ── 3. Team Ranking ──────────────────────────── */}
          <Card className="transition-all duration-300 hover:shadow-lg hover:shadow-primary/5 overflow-hidden">
                        ...
                        return (
                          <div
                            ...
                            className={cn(
                              ...
                              cat
                                ? CATEGORY_COLORS[cat] ?? "bg-primary"
                                : "bg-transparent"
                            )}
                            title={
                              cat
                                ? `${formatHourShort(hour)} - ${CATEGORIES[cat]?.label}`
                                : `${formatHourShort(hour)} - Sin registro`
                            }
                          />
                        );
                      })}
          ...
          {/* ── 5. Highlights ────────────────────────────── */}
          <Card className="transition-all duration-300 hover:shadow-lg hover:shadow-primary/5 border-green-200/60 dark:border-green-800/30">
            <CardHeader className="pb-2">
              <CardTitle className="flex items-center gap-2 text-base">
            ...
            <CardContent className="p-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="flex items-center gap-3 bg-green-50 dark:bg-green-950/20 rounded-xl p-3">
                ...
                {totalFlags > 0 && (
                  <div className="flex items-center gap-3 bg-yellow-50 dark:bg-yellow-950/20 rounded-xl p-3">
                    <div className="w-9 h-9 rounded-lg bg-yellow-100 dark:bg-yellow-900/40 flex items-center justify-center shrink-0">
          ...
          {(lowlightNoLog.length > 0 ||
            ...
            <Card className="transition-all duration-300 hover:shadow-lg hover:shadow-primary/5 border-red-200/60 dark:border-red-800/30">
              <CardHeader className="pb-2">
                  ...
                  <div className="bg-red-50 dark:bg-red-950/20 rounded-xl p-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {lowlightNoLog.map((m) => (
                        <div
                          key={m.profile.id}
                          className="flex items-center gap-1.5 bg-white dark:bg-red-900/30 rounded-lg px-2.5 py-1.5 border border-red-200 dark:border-red-800"
                        >
                  ...
                  <div className="bg-red-50 dark:bg-red-950/20 rounded-xl p-4">
                    ...
                    <div className="space-y-1.5">
                      {unresolvedFlags.map((f) => (
                        <div
                          key={f.id}
                          className="flex items-center gap-2 bg-white dark:bg-red-900/30 rounded-lg px-2.5 py-1.5 border border-red-200 dark:border-red-800 text-xs"
                        >
                          <Avatar className="w-5 h-5 ring-1 ring-red-200">
                            <AvatarImage
