...
export default function ProfilePage() {
 ...
 <Avatar className="w-20 h-20 ring-4 ring-primary/10 shadow-primary/10">
 ...
 <p className="text-xs text-muted-foreground mt-0.5">{profile.timezone}</p>
 </div>
 </div>

 {/* Stats cards */}
 <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8">
 <Card className="overflow-hidden relative hover:border-primary/30 transition-all duration-300">
 <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-transparent"/>
 <CardContent className="p-4 text-center relative">
 <div className="w-9 h-9 bg-primary/10 dark:bg-primary/15 flex items-center justify-center mx-auto mb-2">
 ...
 <Card className="overflow-hidden relative hover:shadow-blue-500/5 transition-all duration-300">
 <div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 to-transparent"/>
 <CardContent className="p-4 text-center relative">
 <div className="w-9 h-9 bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center mx-auto mb-2">
 ...
 <Card className="overflow-hidden relative hover:shadow-emerald-500/5 transition-all duration-300">
 <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/5 to-transparent"/>
 <CardContent className="p-4 text-center relative">
 <div className="w-9 h-9 bg-emerald-100 dark:bg-emerald-900/30 flex items-center justify-center mx-auto mb-2">
 ...
 <Card className="overflow-hidden relative hover:shadow-amber-500/5 transition-all duration-300">
 <div className="absolute inset-0 bg-gradient-to-br from-amber-500/5 to-transparent"/>
 <CardContent className="p-4 text-center relative">
 <div className="w-9 h-9 bg-amber-100 dark:bg-amber-900/30 flex items-center justify-center mx-auto mb-2">
...
"h-full rounded-full transition-all duration-500",
 ...
 <div
 className={cn(
"w-11 h-11 flex items-center justify-center text-xs font-semibold tabular-nums transition-all duration-300",
 intensity === 0
 ?"bg-muted/30 text-muted-foreground": intensity < 0.33
 ?"bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300": intensity < 0.66
 ?"bg-blue-300 dark:bg-blue-700/60 text-blue-900 dark:text-blue-100":"bg-primary text-white shadow-blue-600/20")}
 >
 {count}
 </div>
