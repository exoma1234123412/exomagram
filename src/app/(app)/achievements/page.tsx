...
> = {
 ...
 proof_100: { label:"100% evidencia", emoji:"--", description:"Semana completa con 100% de entradas con evidencia"},
 zero_late: { label:"Siempre a tiempo", emoji:"--", description:"Semana sin entradas tardías"},
 first_logger: { label:"Madrugador", emoji:"AM", description:"Primero en registrar 5 veces"},
 ...
 primer_sangre: { label:"Primer sangre", emoji:"--", description:"Primera entrada del día para el equipo, 5 veces", secret: true },
...
"transition-all duration-300 relative overflow-hidden",
 isUnlocked
 ?"border-yellow-300/60 dark:border-yellow-700/40 shadow-yellow-500/10 ring-1 ring-yellow-300/30":"opacity-50 grayscale")}
 >
