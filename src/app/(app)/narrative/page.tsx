...
export default function NarrativePage() {
 ...
 .replace(/OK/g, '<span class="text-green-600">OK</span>')
 ...
 <Card className="border-green-200 dark:border-green-800 transition-all duration-300 hover:border-primary/30">
 ...
 <Card className="border-orange-200 dark:border-orange-800 transition-all duration-300 hover:border-primary/30">
 <CardContent className="p-4">
 <h3 className="font-semibold text-sm flex items-center gap-2 mb-2">
