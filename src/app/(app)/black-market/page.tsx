...
"flex-1 rounded-t-sm transition-all duration-500",
 isLast
 ? positive
 ?"bg-green-400":"bg-red-400": positive
 ?"bg-green-400/30":"bg-red-400/30",
 )}
 style={{ height:`${height}%`}}
 />
 );
...
"text-[10px] tabular-nums gap-0.5",
 isUp
 ?"text-green-600 dark:text-green-400 border-green-200 dark:border-green-800":"text-red-600 dark:text-red-400 border-red-200 dark:border-red-800",
 )}
 >
 {isUp ? (
...
"flex items-center gap-3 p-2.5",
 ...
 <span
 className={cn(
"w-6 h-6 flex items-center justify-center text-xs font-bold tabular-nums",
 idx === 0
 ?"bg-amber-100 dark:bg-amber-900/40 text-amber-700 dark:text-amber-400": idx === 1
 ?"bg-slate-100 dark:bg-slate-800/40 text-slate-600 dark:text-slate-400": idx === 2
 ?"bg-orange-100 dark:bg-orange-900/40 text-orange-700 dark:text-orange-400":"bg-accent text-muted-foreground",
 )}
 >
 {idx + 1}
 </span>
...
"w-8 h-8 flex items-center justify-center text-xs font-bold shrink-0",
 isBuy
 ?"bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400":"bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400",
 )}
 >
 {isBuy ? (
