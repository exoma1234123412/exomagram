    ...
    <Card className="transition-all duration-300 hover:shadow-lg hover:shadow-primary/5 overflow-hidden">
      ...
      <CardContent className="space-y-5">
        ...
        <div>
          ...
          <div className="relative rounded-xl bg-zinc-950 dark:bg-zinc-900 p-4 overflow-x-auto">
        ...
        <div>
          ...
          <div className="relative rounded-xl bg-zinc-950 dark:bg-zinc-900 p-4 overflow-x-auto max-h-72 overflow-y-auto">
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
      ...
      <Card className="mb-8 transition-all duration-300 hover:shadow-lg hover:shadow-primary/5">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="relative rounded-xl bg-zinc-950 dark:bg-zinc-900 p-4">
      ...
      {/* Base URL */}
      <div className="mb-8 flex items-center gap-3 p-3 bg-accent/40 rounded-xl">
      ...
      {/* Endpoint index */}
      <div className="mb-8 rounded-xl border border-border/50 bg-accent/20 p-4 space-y-2">
        {endpoints.map((ep) => (
          <a
            key={`${ep.method}-${ep.path}`}
            href={`#${ep.method.toLowerCase()}-${ep.path.replace(/\//g, "-").slice(1)}`}
            className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-accent/60 transition-colors"
          >
      ...
      {/* Error codes */}
      <Card className="mt-8 transition-all duration-300 hover:shadow-lg hover:shadow-primary/5">
        <CardHeader className="pb-3">
      ...
      <div className="mt-8 text-center">
        <Link href="/integrations">
          <Button className="gap-2 bg-gradient-to-r from-blue-600 to-blue-700 shadow-blue-600/25 shadow-lg">
