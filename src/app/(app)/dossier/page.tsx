      ...
      if (totalChecked >= 2) {
        ...
        findings.push({
          ...
          description: improvementRate > 0.5
            ? `${memberName} reacciona positivamente cuando recibe flags. La presión funciona.`
            : `${memberName} NO mejora después de recibir flags. La presión no tiene efecto.`,
          evidence: [
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="mb-8">
        ...
        <div className="relative">
          ...
          {selectorOpen && (
            <div className="absolute z-50 w-full mt-1 border border-border bg-background shadow-lg max-h-64 overflow-y-auto">
              {members.map((m) => (
                <button
                  key={m.userId}
                  onClick={() => {
        ...
        <div className="space-y-8">
          ...
          <div className="border border-border p-5">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className={cn("px-3 py-1.5 border", riskConfig.bg)}>
                <p className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground/50">
                  RIESGO
                </p>
            ...
            <div className="grid grid-cols-4 gap-3 pt-4 border-t border-border">
              <div className="bg-accent/30 border border-border p-3">
                <p className="font-mono text-[9px] uppercase text-muted-foreground/50 tracking-wider">
                  Entradas
                </p>
          ...
          <div className={cn("border p-5", riskConfig.bg, SEVERITY_CONFIG[riskLevel >= 4 ? "high" : riskLevel >= 3 ? "medium" : "low"].border)}>
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground/50 mb-1">
                  NIVEL DE RIESGO
                </p>
          ...
          <div className="border border-border p-5">
            ...
            <div className="mt-4 pt-3 border-t border-border flex items-center justify-between">
              <p className="font-mono text-[9px] text-muted-foreground/30 uppercase tracking-wider">
