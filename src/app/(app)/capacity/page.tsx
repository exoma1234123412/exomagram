...
export default function CapacityPage() {
 ...
 {/* Background arc */}
 <path
 d="M 20 100 A 80 80 0 0 1 180 100"fill="none"stroke="currentColor"strokeWidth="14"strokeLinecap="round"className="text-muted"/>
 {/* Filled arc */}
 <path
 d="M 20 100 A 80 80 0 0 1 180 100"fill="none"stroke={utilization > 100 ?"#ef4444": utilization >= 80 ?"#22c55e": utilization >= 50 ?"#eab308":"#ef4444"}
 strokeWidth="14"strokeLinecap="round"strokeDasharray={`${Math.min(utilization, 100) * 2.51} 251`}
 />
 {/* Center text */}
 ...
 <div className="h-4 bg-muted rounded-full overflow-hidden">
 <div
 className="h-full rounded-full bg-blue-400 transition-all duration-700"style={{ width:`${totalCapacity > 0 ? Math.round((availableHours / totalCapacity) * 100) : 0}%`}}
 />
 </div>
 </div>
...
"text-[10px] shrink-0",
 m.utilization > 100
 ?"text-red-600 border-red-300": m.utilization >= 80
 ?"text-green-600 border-green-300": m.utilization >= 50
...
"font-medium",
 ...
 {/* Ideal marker */}
 <div
 className="absolute top-0 bottom-0 w-0.5 bg-foreground/40 z-10"style={{ left:`${ideal}%`}}
 />
 {/* Actual bar */}
 <div
...
"w-full rounded-t-lg transition-all duration-500",
 isCurrentWeek
 ?"bg-gradient-to-t from-primary to-primary/70": getUtilizationBg(wh.utilization),
 )}
...
"flex items-center justify-between text-xs p-2",
 ...
 <div className="flex items-center justify-between text-xs p-2 border border-dashed">
