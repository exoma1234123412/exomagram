...
export default function InvertedPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
      ...
      {isInvertedToday ? (
        <div className="relative mb-8 overflow-hidden rounded-2xl bg-gradient-to-r from-fuchsia-600 via-purple-600 to-fuchsia-700 p-6 text-white shadow-lg shadow-fuchsia-600/25">
        ...
        <Card className="mb-8 transition-all duration-300 hover:shadow-lg hover:shadow-primary/5 border-fuchsia-500/20">
                ...
                >
                  <CardContent className="p-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div
                        className={cn(
                          "flex items-center justify-center w-8 h-8 rounded-lg font-bold text-sm tabular-nums tracking-tight shrink-0",
                          isTop
      ...
      {/* How it works */}
      <section className="mb-8">
        <Card className="transition-all duration-300 hover:shadow-lg hover:shadow-primary/5 border-fuchsia-500/10">
