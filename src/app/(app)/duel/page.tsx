          ...
          <div className="space-y-3">
            {pendingDuels
              ...
              .map((duel) => (
                <Card
                  key={duel.id}
                  className="transition-all duration-300 hover:shadow-lg hover:shadow-primary/5 border-amber-300/50 dark:border-amber-700/40"
                >
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex gap-2">
                        <Button
                          ...
                          onClick={() => respondToDuel(duel.id, false)}
                        >
                          <X className="w-3 h-3" />
                          Declinar
                        </Button>
                        <Button
                          size="sm"
                          className="rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 text-white border-0 gap-1"
                          onClick={() => respondToDuel(duel.id, true)}
                        >
          ...
          <div className="space-y-3">
            {pendingDuels
              ...
              .map((duel) => (
                <Card
                  key={duel.id}
                  className="transition-all duration-300 hover:shadow-lg hover:shadow-primary/5 opacity-70"
                >
                  <CardContent className="p-4">
                    <div className="flex items-center gap-3">
          ...
          <div className="space-y-4">
            {activeDuels.map((duel) => {
              ...
              return (
                <Card
                  key={duel.id}
                  className="transition-all duration-300 hover:shadow-lg hover:shadow-primary/5 overflow-hidden"
                >
                      ...
                      <div className="relative grid grid-cols-[1fr_auto_1fr] items-center gap-4 p-6 sm:p-8">
                        ...
                        <div className="flex flex-col items-center text-center gap-3">
                          <div className={cn(
                            ...
                            <Avatar className="w-16 h-16 sm:w-20 sm:h-20 ring-4 ring-blue-500/30 shadow-lg shadow-blue-500/20">
                              <AvatarImage src={duel.challenger_profile.avatar_url ?? undefined} />
                        ...
                        <div className="flex flex-col items-center gap-2">
                          <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-gradient-to-br from-amber-400 to-orange-500 flex items-center justify-center shadow-lg shadow-orange-500/30">
                        ...
                        <div className="flex flex-col items-center text-center gap-3">
                          <div className={cn(
                            ...
                            <Avatar className="w-16 h-16 sm:w-20 sm:h-20 ring-4 ring-red-500/30 shadow-lg shadow-red-500/20">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
            {winRecords.map((r) => {
              ...
              return (
                <div
                  key={r.userId}
                  className="bg-accent/40 rounded-xl p-3 flex items-center gap-3"
                >
                ...
                >
                  <CardContent className="p-4">
                    ...
                    {duel.loser_confession && (
                      <div className="mt-3 p-3 bg-accent/40 rounded-xl flex items-start gap-2">
                    ...
                    {iAmLoser && (
                      <div className="mt-3 flex justify-center">
                        <Button
                          variant="outline"
                          size="sm"
                          className="rounded-xl gap-1.5 text-xs text-red-600 border-red-200 dark:border-red-900 hover:bg-red-50 dark:hover:bg-red-950"
                          onClick={() => {
      ...
      <Dialog open={challengeOpen} onOpenChange={setChallengeOpen}>
        <DialogContent className="rounded-2xl sm:max-w-md">
          ...
          <DialogFooter>
            ...
            <Button
              className="rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 text-white border-0 gap-1.5"
      ...
      <Dialog open={confessionOpen} onOpenChange={setConfessionOpen}>
        <DialogContent className="rounded-2xl sm:max-w-md">
          ...
          <DialogFooter>
            ...
            <Button
              className="rounded-xl bg-gradient-to-r from-red-600 to-red-700 text-white border-0 gap-1.5"
