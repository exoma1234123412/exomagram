    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
      ...
      {showForm && (
        <Card className="mb-8 border-2 border-dashed">
          <CardContent className="p-6">
            ...
            <Textarea
              placeholder="Escribe tu confesión (mínimo 20 caracteres)..."
              value={text}
      ...
      {myConfession && (
        <div className="mb-8">
          ...
          <Card className="border-2 border-primary/20 transition-all duration-300 hover:shadow-lg hover:shadow-primary/5">
