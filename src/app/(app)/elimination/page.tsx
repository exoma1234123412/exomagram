...
export default function EliminationPage() {
 ...
 <div className="mb-6 flex items-start gap-3 px-4 py-3 bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-800">
...
"w-10 h-10 flex items-center justify-center text-lg font-black",
 ...
 {isLast && (
 <div className="mt-3 flex items-center gap-2 px-3 py-2 bg-red-100 dark:bg-red-900/20 text-red-700 dark:text-red-400 text-xs font-medium">
 ...
 <Textarea
 placeholder="Mi plan para mejorar el próximo mes es..."value={planText}
 onChange={(e) => setPlanText(e.target.value)}
 className="min-h-[120px] mb-3"maxLength={2000}
 autoComplete="off"/>
...
"text-xs",
 ...
 <Button
 className="bg-primary text-white border-0 gap-2"disabled={planText.trim().length < 20 || submitting}
 onClick={submitPlan}
 >
 {submitting ? (
 ...
 return (
 <Card key={pm.month} className="transition-all duration-300 hover:border-primary/30">
 <CardContent className="p-4">
...
"w-5 text-center font-bold tabular-nums text-xs",
 ...
 <div className="flex items-center gap-2 text-sm bg-red-50 dark:bg-red-950/20 p-2">
 ...
 {loser && !loserPlan && (
 <div className="bg-red-50 dark:bg-red-950/20 p-3 mt-2 text-center">
