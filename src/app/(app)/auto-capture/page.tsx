...
export default function AutoCapturePage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
      ...
      {/* ------------------------------------------------------------------ */}
      <div className="mb-8">
        <span className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground/40 block mb-3">
          Resumen de Captura
        </span>
        ...
        <div className="mb-8">
          ...
          <div className="border border-border bg-grid-palantir p-4 space-y-5">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <span className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground/40 block">
                  Horario típico
                </span>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="w-full relative" style={{ height: "48px" }}>
                        <div
                          className="absolute bottom-0 left-0 right-0 bg-primary/30 border border-primary/20 transition-all duration-300"
                    ...
                    return (
                      ...
                      >
                        <div
                          ...
                          title={
                            category
                              ? `${formatHour(hour)}: ${CATEGORIES[category]?.label}`
                              : formatHour(hour)
                          }
                        >
                          {label}
          ...
          <>
            <div className="flex items-center gap-3 mb-2">
              ...
              {selectedGithub.size > 0 && (
                <Button
                  size="sm"
                  className="font-mono text-xs h-7 px-3 gap-1.5"
                  disabled={acceptingGithub}
                ...
                return (
                  ...
                  >
                    ...
                    {suggestion.description && (
                      <span className="font-mono text-[10px] text-muted-foreground/50 truncate max-w-32 shrink-0 hidden sm:block">
                        {suggestion.description.replace("Repo: ", "")}
                      </span>
                    )}

                    {/* Date + Hour */}
                    <span className="font-mono tabular-nums text-[10px] text-muted-foreground/50 shrink-0">
