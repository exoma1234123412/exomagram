...
export default function PredictionsPage() {
 ...
 <div
 className="h-full bg-gradient-to-r from-green-400 to-green-500 transition-all duration-500"style={{ width:`${yesPercent}%`}}
 />
 <div
 className="h-full bg-gradient-to-r from-red-400 to-red-500 transition-all duration-500"style={{ width:`${noPercent}%`}}
 />
 </div>
...
"w-10 h-10 flex items-center justify-center shrink-0",
 isResolved
 ? resolvedYes
 ?"bg-green-100 dark:bg-green-900/30":"bg-red-100 dark:bg-red-900/30":"bg-primary/10")}>
 {isResolved ? (
 resolvedYes ? (
...
"text-[11px]",
 ...
 <Button
 size="sm"className="mt-3 gap-1.5"onClick={() => openBetDialog(prediction)}
 >
...
"w-6 h-6 ring-2 ring-background",
 ...
 <Button
 className="gap-2 bg-primary text-white border-0"onClick={() => setCreateOpen(true)}
 >
 ...
 <button
 key={i}
 className="w-full text-left text-sm px-4 py-2.5 bg-accent/40 hover:bg-accent/60 transition-colors flex items-center gap-2"onClick={() => {
 setNewQuestion(ex);
 setCreateOpen(true);
 }}
 >
...
"transition-all duration-300",
 i === 0 &&"border-yellow-300/60 dark:border-yellow-700/40 shadow-yellow-500/10 ring-1 ring-yellow-300/30")}>
...
"text-2xl font-bold tabular-nums tracking-tight",
 ...
 <Card key={u.profile.id} className="transition-all duration-300 hover:border-primary/30">
...
"text-lg font-bold tabular-nums tracking-tight",
 ...
 <Input
 placeholder="¿Superamos 30hrs de Deep Work esta semana?"value={newQuestion}
 ...
 <button
 key={i}
 type="button"className="text-[11px] px-2.5 py-1 bg-accent/60 hover:bg-accent transition-colors text-muted-foreground hover:text-foreground"onClick={() => setNewQuestion(ex)}
 >
 {ex}
 </button>
 ))}
 ...
 <Button
 type="submit"className="w-full bg-primary text-white border-0"disabled={submitting || !newQuestion.trim() || !newDate}
 >
 ...
 <button
 type="button"onClick={() => setBetChoice("yes")}
 className={cn(
"flex flex-col items-center gap-2 p-4 border-2 transition-all duration-200",
 betChoice ==="yes"?"border-green-500 bg-green-50 dark:bg-green-950/30 shadow-green-500/10":"border-border hover:border-green-300 hover:bg-green-50/50 dark:hover:bg-green-950/10")}
 >
...
"font-semibold",
 ...
 <button
 type="button"onClick={() => setBetChoice("no")}
 className={cn(
"flex flex-col items-center gap-2 p-4 border-2 transition-all duration-200",
 betChoice ==="no"?"border-red-500 bg-red-50 dark:bg-red-950/30 shadow-red-500/10":"border-border hover:border-red-300 hover:bg-red-50/50 dark:hover:bg-red-950/10")}
 >
...
"h-full rounded-full transition-all duration-300",
 betChoice ==="yes"?"bg-gradient-to-r from-green-400 to-green-500":"bg-gradient-to-r from-red-400 to-red-500")}
 ...
 <Button
 className="w-full bg-primary text-white border-0"disabled={!betChoice || betSubmitting}
