    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        <div className="space-y-1.5">
          ...
          <Input
            placeholder="Ej: Revisar PR del feature de autenticacion..."
        ...
        {estimate && categoryInfo && (
          <div className="space-y-3 pt-1">
            ...
            <div className="flex gap-3 p-3 bg-blue-50 dark:bg-blue-950/20 border border-blue-200/60 dark:border-blue-800/40 rounded-xl">
...
function ExportImportSection() {
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        {/* Quick CSV export */}
        <div className="flex gap-3 p-4 rounded-2xl border border-border/50 bg-accent/20">
        ...
        <a
          href="/settings"
          className="flex gap-3 p-4 rounded-2xl border border-border/50 hover:bg-accent/40 transition-colors group"
        >
