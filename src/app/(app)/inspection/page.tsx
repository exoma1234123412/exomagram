  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
      ...
      {!inspectionDone ? (
        ...
        <div className="border-2 border-amber-500/50 bg-amber-500/5 p-6 sm:p-8 mb-8">
          ...
          <div className="mt-4 flex items-center gap-2">
            ...
            <p className="font-mono text-[9px] tracking-[0.15em] uppercase text-muted-foreground/30">
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    >
                      ...
                      {isMe && (
                        <span className="ml-1.5 font-mono text-[9px] text-muted-foreground/50 tracking-widest uppercase">
                          (tú)
                        </span>
                      )}
                    </p>
      ...
      <div className="border border-border/30 p-4 text-center">
        ...
        <p className="font-mono text-sm font-bold tracking-tight text-muted-foreground/40">
