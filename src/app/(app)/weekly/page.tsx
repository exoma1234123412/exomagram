...
export default function WeeklyPage() {
 ...
 <Button
 variant="outline"size="icon"className=""onClick={() => setWeekStart(subDays(weekStart, 7))}
 >
 <ChevronLeft className="w-4 h-4"/>
 </Button>
 <Button
 variant="outline"size="sm"className=""onClick={() => setWeekStart(startOfWeek(new Date(), { weekStartsOn: 1 }))}
 >
 Esta semana
 </Button>
 <Button
 variant="outline"size="icon"className=""onClick={() => {
 ...
 return (
 <Card key={s.profile.id} className="transition-all duration-300 hover:border-primary/30 hover:-translate-y-0.5">
 ...
 <div className="text-center p-2 bg-accent/40">
 <p
 className={cn(
"text-lg font-bold",
 hoursPercent >= 80
 ?"text-green-600": hoursPercent >= 50
...
"w-full rounded-t-lg transition-all duration-500",
 ...
 ?"bg-gradient-to-t from-green-500 to-emerald-400": h >= 4
 ?"bg-gradient-to-t from-yellow-500 to-amber-400": h > 0
 ?"bg-gradient-to-t from-red-500 to-red-400":"bg-muted")}
