...
export default function BrutalTruthPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
      ...
      <p className="font-mono text-xs text-muted-foreground/50 mb-8 ml-8">
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="border border-red-500/10 p-3 text-center">
              ...
              <p className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground/40 mt-1">
                Devastador
              </p>
            </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <Badge
                variant="outline"
                className="font-mono text-[9px] border-red-500/20 text-red-500/60"
              >
                {allTruths.length}
              </Badge>
            </div>
