            ...
            {movements.map((mv) => {
              ...
              return (
                ...
                >
                  ...
                  <Minus className="w-3 h-3 text-muted-foreground/30 shrink-0" />
                  <span
                    className={cn(
          ...
          <div key={tierLevel} className="mb-6">
            ...
            >
              ...
              <div className="flex flex-wrap gap-x-4 gap-y-1 mt-1.5">
                <div>
                  <span className="font-mono text-[8px] tracking-[0.15em] uppercase text-muted-foreground/30">
                    VISIBLE:
                  </span>
                  {config.visibleData.map((v) => (
                    <span
                      key={v}
                      className="font-mono text-[9px] text-muted-foreground/50 ml-1.5"
                    >
                      {v}
                    </span>
                  ))}
                            ...
                            return (
                              ...
                              >
                                ...
                                <div className="flex-1 min-w-0">
                                  ...
                                  {entry.description && (
                                    <p className="font-mono text-[9px] text-muted-foreground/50 mt-0.5 truncate">
                                      {entry.description}
                                    </p>
                                  )}
                                </div>
          ...
          {tierOrder.map((tierLevel) => {
            ...
            return (
              ...
              >
                ...
                <div className="space-y-1">
                  <p className="font-mono text-[8px] tracking-[0.15em] uppercase text-muted-foreground/30">
                    RESTRICCIONES
                  </p>
                  ...
                  <p className="font-mono text-[8px] tracking-[0.15em] uppercase text-muted-foreground/30 mt-1.5">
                    COMO SUBIR
                  </p>
                  <p className="font-mono text-[9px] text-muted-foreground/50">
                    {config.howToMoveUp}
