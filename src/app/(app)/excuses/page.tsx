        ...
        <Card className="border-2 border-dashed border-primary/30 transition-all duration-300 hover:shadow-lg hover:shadow-primary/5">
          <CardContent className="p-8 text-center">
            ...
            <Button
              onClick={runAnalysis}
              disabled={loading}
              className="rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 text-white shadow-lg shadow-blue-600/25 hover:shadow-xl hover:shadow-blue-600/30 transition-all duration-300 gap-2"
            >
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex items-center gap-2">
            {suspiciousCount > 0 && (
              <Badge
                variant="outline"
                className="text-[10px] text-amber-600 border-amber-200 dark:border-amber-900 gap-1"
              >
            ...
            {legitCount > 0 && (
              <Badge
                variant="outline"
                className="text-[10px] text-green-600 border-green-200 dark:border-green-900 gap-1"
              >
      ...
      <div className="flex items-start gap-3">
        ...
        <Badge
          ...
          className={cn(
            "text-[10px] shrink-0",
            isSuspicious
              ? "text-amber-700 bg-amber-100/50 dark:bg-amber-900/30 border-amber-300 dark:border-amber-800"
              : "text-green-700 bg-green-100/50 dark:bg-green-900/30 border-green-300 dark:border-green-800"
          )}
        >
