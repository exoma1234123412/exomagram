    ...
    return (
      <div className="flex items-center justify-center h-screen">
        <div className="flex flex-col items-center gap-3">
          <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-blue-700 animate-pulse" />
  ...
  if (!entry) {
    return (
      <div className="border border-dashed border-red-500/20 bg-red-500/5 p-2 flex items-center gap-2">
        <span className="font-mono text-[10px] tabular-nums text-muted-foreground/50 w-12 shrink-0">
          {formatHour(hour)}
        </span>
