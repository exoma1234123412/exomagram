            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Input
                  ...
                  placeholder="Describe la tarea a estimar..."
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          newCategory === cat.value
                            ? `${catConfig.bgColor} ${catConfig.color} border-current/20`
                            : "bg-accent/20 text-muted-foreground border-border/30 hover:border-primary/30"
                        )}
                      >
                        <span>{cat.emoji}</span>
                        <span>{cat.label}</span>
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        newAssignee === m.user_id
                          ...
                          : "bg-accent/20 border-border/30 hover:border-primary/30"
                      )}
                    >
                ...
                return (
                  ...
                  >
                    <CardContent className="p-4 flex items-center gap-4">
                      <div className={cn("font-mono font-bold text-xl tabular-nums w-8 text-center", medal || "text-muted-foreground/40")}>
                        {idx + 1}
                      </div>
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-[9px] font-mono uppercase tracking-wider text-muted-foreground/40">
                          precision
                        </p>
                      </div>
                      {idx === 0 && (
      ...
      <CardContent className="p-5">
        ...
        <div className="flex items-start justify-between gap-3 mb-4">
          ...
          <button
            ...
            className="w-6 h-6 flex items-center justify-center text-muted-foreground/30 hover:text-destructive transition-colors shrink-0"
          >
                  ...
                  {HOUR_OPTIONS.map((h) => (
                    <button
                      ...
                      className={cn(
                        ...
                        myEstimate?.hours === h
                          ? "bg-amber-500/20 text-amber-600 border-amber-500/50 scale-110"
                          : "bg-accent/20 text-muted-foreground border-border hover:border-amber-500/30 hover:text-amber-600"
                      )}
                    >
                      {h}
                    </button>
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  <Input
                    ...
                    max="24"
                    step="0.5"
                    value={actualInput[round.id] ?? ""}
                    onChange={(e) =>
                      setActualInput((prev) => ({ ...prev, [round.id]: e.target.value }))
                    }
                    placeholder="Ej: 3.5"
                    className="font-mono text-lg tabular-nums max-w-[120px]"
                  />
                  <Button
      ...
      <CardContent className="p-5">
        ...
        <div className="grid grid-cols-3 gap-3 mb-4">
          <div className="bg-accent/30 border border-border p-3 text-center">
            <p className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground/40 mb-0.5">
              Estimado
            </p>
