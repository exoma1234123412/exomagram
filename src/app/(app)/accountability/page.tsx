...
export default function AccountabilityPage() {
 ...
 <Button variant="ghost"size="icon"className=""onClick={() => setDate(subDays(new Date(date +"T12:00:00"), 1).toISOString().split("T")[0])}>
 ...
 {!isToday && (
 <Button variant="secondary"size="sm"className="text-xs font-semibold"onClick={() => setDate(new Date().toISOString().split("T")[0])}>
 Hoy
 </Button>
 )}
 </div>
...
"text-xs",
 flagInfo.severity ==="high"?"text-red-600 border-red-300 bg-red-50 dark:bg-red-950/20": flagInfo.severity ==="medium"?"text-orange-600 border-orange-300 bg-orange-50 dark:bg-orange-950/20":"text-yellow-600 border-yellow-300 bg-yellow-50 dark:bg-yellow-950/20")}
 >
