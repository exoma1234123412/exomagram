  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-8">
        ...
        <div className="bg-accent/30 border border-border p-4">
          ...
          <p className="font-mono text-[10px] text-muted-foreground mt-1">
            {trend.direction === "faster"
              ? "Mas rapido que la semana anterior"
              : trend.direction === "slower"
                ? "Mas lento que la semana anterior"
      ...
      <div className="mb-8">
        ...
        <div className="border border-border divide-y divide-border">
          ...
          <div className="grid grid-cols-[2.5rem_1fr_5rem_5rem_5rem_4.5rem] sm:grid-cols-[2.5rem_1fr_5.5rem_5.5rem_5.5rem_5rem_5rem] gap-1 px-3 py-2 bg-accent/20">
            ...
            <span className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground/40 text-right">
              Prom
            </span>
            <span className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground/40 text-right">
              Mejor
            ...
            <span className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground/40 text-right hidden sm:block">
              &lt;30m
            </span>
            <span className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground/40 text-right">
              Tarde
                ...
                <span
                  className={cn(
                    ...
                    s.totalEntries === 0
                      ...
                      : responseColor(s.avgResponseMin)
                  )}
                >
                  {s.totalEntries === 0
                    ? "--"
      ...
      <div className="text-center py-4 border-t border-border/30">
        <p className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground/30">
