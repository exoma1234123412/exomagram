...
"inline-flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium transition-all",
 !selectedMember
 ?"bg-primary text-primary-foreground":"bg-accent/60 text-muted-foreground hover:bg-accent hover:text-foreground")}
 >
...
"aspect-square rounded-sm transition-all duration-200 cursor-default relative group",
 ...
 <div className="w-8 h-8 bg-slate-300/60 dark:bg-slate-700/60 flex items-center justify-center">
 <EyeOff className="w-4 h-4 text-muted-foreground"/>
 </div>
