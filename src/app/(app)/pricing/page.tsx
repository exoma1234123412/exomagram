...
"text-sm font-medium transition-colors",
 ...
 <button
 type="button"role="switch"aria-checked={annual}
...
"relative flex flex-col transition-all duration-300",
 isPopular
 ?"border-2 border-blue-500 shadow-blue-600/10 scale-[1.02] md:scale-105":"hover:-translate-y-1")}
 >
 {/* Most popular badge */}
 {isPopular && (
...
"w-10 h-10 flex items-center justify-center text-white",
 ...
 {isPopular ? (
 <span className="w-full inline-flex items-center justify-center gap-2 px-6 py-3 bg-primary text-white font-semibold hover:shadow-blue-600/40 transition-all hover:scale-[1.02] text-sm">
 {tier.cta}
 </span>
 ) : (
 <Button
 variant="outline"size="lg"className="w-full h-12 text-sm font-semibold">
 {tier.cta}
 </Button>
 )}
 </Link>
...
"w-4 h-4 mt-0.5 shrink-0",
 isPopular
 ?"text-blue-500":"text-green-500 dark:text-green-400")}
 />
 <span>{feat}</span>
 </li>
 ))}
...
"border-b border-border/30 transition-colors hover:bg-muted/30",
 ...
 <div
 key={i}
 className="border border-border/50 bg-card overflow-hidden transition-all">
 <button
 type="button"onClick={() => setOpenFaq(isOpen ? null : i)}
...
"grid transition-all duration-200",
 ...
 <Link
 href="/signup?plan=enterprise"className="inline-flex items-center gap-2 px-8 py-4 border-2 border-border font-semibold text-lg hover:bg-accent transition-all">
 Contactar ventas
 </Link>
 </div>
 </section>
