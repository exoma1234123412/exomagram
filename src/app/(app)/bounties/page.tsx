    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
      ...
      {!showForm ? (
        <Button
          ...
          className="mb-8 rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 text-white border-0 shadow-lg shadow-blue-600/25 gap-2"
        >
          ...
          <CardContent className="p-6">
            ...
            <form onSubmit={createBounty} className="space-y-4">
              <div>
                ...
                <Textarea
                  id="bounty-title"
                  placeholder="Quien resuelva [tarea] gana puntos..."
                  value={title}
              ...
              <div className="flex gap-2 justify-end">
                ...
                <Button
                  type="submit"
                  disabled={submitting || title.trim().length < 10 || !deadline}
        ...
        <div className="mb-8">
          ...
          <div className="space-y-3">
            {openBounties.map((b) => (
              <Card
                key={b.id}
                className="transition-all duration-300 hover:shadow-lg hover:shadow-primary/5 border-green-200 dark:border-green-900"
              >
                <CardContent className="p-4">
                  <div className="flex items-start gap-3">
                    <Avatar className="w-8 h-8 ring-2 ring-background shadow-sm mt-0.5">
                        ...
                        <>
                          {claimingBountyId === b.id ? (
                            <div className="mt-3 space-y-2">
                              <Input
                                placeholder="URL de evidencia (link al PR, screenshot, etc.)"
                                value={claimEvidence}
                              ...
                              <div className="flex gap-2">
                                <Button
                                  ...
                                  onClick={() => { setClaimingBountyId(null); setClaimEvidence(""); }}
                                >
                                  Cancelar
                                </Button>
                                <Button
                                  ...
                                  disabled={!claimEvidence.trim() || claiming === b.id}
                            ...
                            <Button
                              ...
                              onClick={() => setClaimingBountyId(b.id)}
                            >
                              <Hand className="w-3 h-3" />
                              Reclamar
                            </Button>
        ...
        <div className="mb-8">
          ...
          <div className="space-y-3">
            {claimedBounties.map((b) => (
              <Card
                key={b.id}
                className="transition-all duration-300 hover:shadow-lg hover:shadow-primary/5 border-amber-200 dark:border-amber-900"
              >
                <CardContent className="p-4">
                  <div className="flex items-start gap-3">
                    <Avatar className="w-8 h-8 ring-2 ring-background shadow-sm mt-0.5">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {b.user_id === userId && (
                        <Button
                          size="sm"
                          className="mt-3 rounded-xl text-xs gap-1 bg-green-600 hover:bg-green-700 text-white"
        ...
        <div className="mb-8">
          ...
          <div className="space-y-3">
            {completedBounties.map((b) => (
              <Card
                key={b.id}
                className="transition-all duration-300 hover:shadow-lg hover:shadow-primary/5 opacity-80"
              >
                <CardContent className="p-4">
