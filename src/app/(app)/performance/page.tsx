...
`- ${tc.label}: ${tc.userValue}${tc.suffix} vs ${tc.teamAvg}${tc.suffix} (percentil ${tc.percentile})`);
 ...
 {report && (
 <Button
 variant="outline"size="sm"className="gap-2 ml-auto"onClick={exportMarkdown}
 >
 {copied ? (
 <>
...
"text-2xl font-bold tabular-nums tracking-tight",
 ...
 ?"text-green-600": report.output.proofRate >= 50
...
"text-lg font-bold tabular-nums",
 ...
 ?"text-green-600": report.behavior.closeoutRate >= 50
 ?"text-yellow-600":"text-red-600")}
 >
 ...
 <div className="flex items-center gap-3 p-4 bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800">
...
"flex items-start gap-3 p-3 border",
 risk.severity ==="high"?"bg-red-50 dark:bg-red-950/20 border-red-200 dark:border-red-800": risk.severity ==="medium"?"bg-orange-50 dark:bg-orange-950/20 border-orange-200 dark:border-orange-800":"bg-yellow-50 dark:bg-yellow-950/20 border-yellow-200 dark:border-yellow-800")}
 >
 <AlertCircle
 className={cn(
"w-4 h-4 mt-0.5 shrink-0",
 risk.severity ==="high"?"text-red-600": risk.severity ==="medium"?"text-orange-600":"text-yellow-600")}
 />
 <div>
 <p
 className={cn(
"text-sm font-medium",
 risk.severity ==="high"?"text-red-700 dark:text-red-400": risk.severity ==="medium"?"text-orange-700 dark:text-orange-400":"text-yellow-700 dark:text-yellow-400")}
 >
 {risk.label}
 </p>
...
"ml-auto text-[10px] shrink-0",
 risk.severity ==="high"?"text-red-600 border-red-300": risk.severity ==="medium"?"text-orange-600 border-orange-300":"text-yellow-600 border-yellow-300")}
 >
 ...
 <Badge
 key={idx}
 variant="outline"className="text-[10px] text-green-600 border-green-200 bg-green-50/50 dark:bg-green-950/10">
...
"flex items-center gap-0.5",
 ...
 {/* Team avg marker */}
 <div
 className="absolute top-0 bottom-0 w-0.5 bg-muted-foreground/40 z-10"style={{
 left:`${clamp(
...
"text-[10px]",
 tc.percentile >= 75
 ?"text-green-600 border-green-300": tc.percentile >= 50
 ?"text-blue-600 border-blue-300": tc.percentile >= 25
 ?"text-yellow-600 border-yellow-300":"text-red-600 border-red-300")}
 >
...
"w-full rounded-t-md transition-all duration-300",
 ws.trend ==="up"?"bg-green-500": ws.trend ==="down"?"bg-red-500": scoreBgColor(ws.score)
 )}
 ...
 <CardContent className="p-6 pt-2">
 <div className="bg-accent/40 p-4 space-y-2">
