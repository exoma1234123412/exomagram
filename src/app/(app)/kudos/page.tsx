...
"id, reaction, comment, created_at, user_id, entry_id, time_entries(*, profiles(*))")
 ...
 return (
 <Card key={k.id} className="transition-all duration-300 hover:border-primary/30">
 ...
 <div className="bg-accent/30 p-3 border border-border/50">
 ...
 <Badge
 variant="secondary"className={cn("text-[10px]", cat.color, cat.bgColor)}
 >
 {cat.emoji} {cat.label}
 </Badge>
