...
export default function LeaderboardPage() {
 ...
 size="sm"className={period === p ?"bg-primary text-white border-0":""}
 onClick={() => setPeriod(p)}
 >
 {p}d
 </Button>
...
"transition-all duration-300 hover:-translate-y-0.5",
 index === 0 &&"border-yellow-300/60 dark:border-yellow-700/40 shadow-yellow-500/10 ring-1 ring-yellow-300/30",
