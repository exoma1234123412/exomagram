    ...
    return (
      <div className="flex items-center justify-center h-screen">
        <div className="flex flex-col items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-red-500 to-red-700 animate-pulse" />
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
      ...
      <section className="mb-8">
        <h2 className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground/40 mb-4">
          Mi apuesta
        </h2>
          ...
          {teamWithout.map((profile) => (
            ...
            >
              <CardContent className="p-4 flex items-center gap-3">
                ...
                <Badge
                  variant="outline"
                  className="text-[10px] font-mono text-amber-600 border-amber-300 dark:text-amber-400 dark:border-amber-700"
                >
                  SIN COMPROMISO
                </Badge>
              </CardContent>
    ...
    <Card className="border-2 border-dashed border-red-400/40 dark:border-red-600/30">
      <CardContent className="p-6">
        ...
        <div className="space-y-5">
          ...
          <p className="text-[9px] font-mono text-center text-muted-foreground/50 uppercase tracking-wider">
    ...
    <Card className={cn(
      ...
      <CardContent className="p-5">
        ...
        <div className="flex items-center justify-between mb-4">
          <Badge
            variant="outline"
            className="text-[10px] font-mono gap-1 text-red-600 border-red-300 dark:text-red-400 dark:border-red-700 uppercase tracking-wider"
          >
      ...
      <CardContent className="p-6">
        <div className="text-center mb-5">
          ...
          <p className="text-sm font-mono text-muted-foreground mt-2">
            {isSuccess
              ? "Mantuviste tu palabra. Apuesta cumplida."
              : "No cumpliste tu compromiso irrevocable."}
          </p>
        </div>
