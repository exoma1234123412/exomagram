                  ...
                  {(Object.keys(CATEGORIES) as WorkCategory[]).map((key) => {
                    ...
                    return (
                      <button
                        key={key}
                        type="button"
                        onClick={() => setNewCategory(newCategory === key ? "" : key)}
                        className={cn(
          ...
          <div className="border border-primary/30 bg-primary/5 p-4">
            ...
            <div className="mb-4">
              ...
              <Textarea
                ...
                placeholder="Que lograste en esta sesion?"
                rows={2}
              ...
              return (
                ...
                >
                  ...
                  {s.interruption_count > 0 && (
                    <span className="font-mono text-[9px] tabular-nums text-muted-foreground/50 flex items-center gap-0.5">
                  ...
                  {!s.was_completed && (
                    <Badge
                      variant="outline"
                      className="text-[8px] font-mono text-red-500 border-red-500/30"
                    >
                      Cancelada
                    </Badge>
                  )}
