      ...
      <div className="flex items-center gap-2 mb-8">
        ...
        {date !== getTodayMTY() && (
          <Button
            ...
            onClick={() => handleDateChange(getTodayMTY())}
          >
            Hoy
          </Button>
        )}
          ...
          <div className="border border-border bg-card mb-8">
            ...
            <div className="px-4 pt-3 pb-2">
              ...
              <div className="relative h-6 bg-accent/30 border border-border overflow-hidden">
                ...
                {gaps
                  ...
                  .map((g, i) => {
                    ...
                    return (
                      <div
                        key={`gap-${g.userId}-${i}`}
                        className="absolute inset-y-0 bg-red-500/20 border-x border-red-500/30"
                ...
                {/* Playhead */}
                <div
                  className="absolute top-0 bottom-0 w-px bg-primary shadow-[0_0_4px] shadow-primary/60 transition-[left] duration-100"
              ...
              <div className="flex justify-between mt-1">
                {Array.from({ length: 12 }, (_, i) => i + 7).map((h) => (
                  <span
                    key={h}
                    className="font-mono text-[7px] tabular-nums text-muted-foreground/30"
                  >
                    {h}
                  </span>
                ))}
