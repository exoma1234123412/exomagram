                ...
                <div className="mb-4">
                  ...
                  <div className="h-3 bg-muted/30 rounded-full overflow-hidden flex">
                    <div className="h-full bg-green-500 transition-all"
                      style={{ width: `${v.hours_claimed > 0 ? (v.hours_verified / v.hours_claimed) * 100 : 0}%` }} />
                    <div className="h-full bg-red-400/50 transition-all"
                      style={{ width: `${v.hours_claimed > 0 ? (v.ghost_hours / v.hours_claimed) * 100 : 0}%` }} />
                  </div>
                </div>
