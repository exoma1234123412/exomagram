...
const FEEDBACK_TYPES = {
 ...
 concern: { label:"Preocupación", emoji:"!!", color:"text-yellow-600"},
...
export default function FeedbackPage() {
 ...
 <Label>Mensaje</Label>
 <Textarea
 placeholder="Sé específico y constructivo. ¿Qué podrían mejorar? ¿Qué aprecias?"value={message}
...
"flex items-center gap-2 px-3 py-2 border text-sm transition-colors",
 anonymous
 ?"border-blue-300 bg-blue-50 dark:bg-blue-950/30 dark:border-blue-700":"border-muted")}
 >
 ...
 <Button type="submit"className="w-full bg-primary hover:from-blue-700 hover:to-blue-800 text-white border-0"disabled={submitting || !toUserId || !feedbackType}>
