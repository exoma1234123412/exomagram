...
export default function MemberPage() {
 ...
 <Link
 href="/accountability"className="inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-foreground">
 ...
 <Avatar className="w-16 h-16 ring-4 ring-primary/10 shadow-primary/10">
...
"w-full rounded-t transition-all duration-500",
 s.score >= 80
 ?"bg-green-500": s.score >= 60
 ?"bg-blue-500": s.score >= 40
...
"w-full rounded-t",
 m.mood >= 4
 ?"bg-green-400": m.mood >= 3
 ?"bg-blue-400": m.mood >= 2
