...
export default function SurvivorPage() {
 ...
 {isShowingLastWeek
 ?`Resultados de la semana pasada (${weekLabel})`:`Semana en curso: ${weekLabel}`}
 </p>
 </div>
 ...
 <Crown className="absolute -top-4 left-1/2 -translate-x-1/2 w-8 h-8 text-amber-500 drop-"/>
 </div>
 <div>
...
"text-xs",
 isBattleComplete
 ?"bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400":"bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400")}
 >
...
"transition-all duration-300 hover:border-primary/30",
 ...
 key={score.userId}
 className={cn(
"flex items-center gap-2 py-1.5 px-2 text-sm",
