      ...
      <div
        className={cn(
          ...
          broken
            ...
            : "border-red-700/60 bg-gradient-to-br from-red-800 to-red-950 shadow-[0_0_20px_rgba(220,38,38,0.3)]"
        )}
      />
      {/* Inner ring */}
      <div
  ...
  return (
    <div className="relative w-10 h-6 flex items-center justify-center">
      ...
      <div className="absolute inset-0 border border-muted-foreground/20 rounded-[50%] overflow-hidden">
        {/* Iris */}
        <div
          className="absolute w-3 h-3 rounded-full bg-primary/60 top-1/2 left-1/2 transition-all duration-1000 ease-in-out"
          style={{
      ...
      <CardContent className="p-0">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-mono text-xs tracking-[0.18em] uppercase text-muted-foreground/40">
              ...
              <CardContent className="px-5 py-5 space-y-5">
                ...
                <div>
                  ...
                  <Input
                    ...
                    placeholder="Nombre y comportamiento sospechoso"
                    className="font-mono text-sm"
                    autoComplete="off"
                  />
                </div>
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="Describe patrones, anomalías, o comportamiento inusual..."
