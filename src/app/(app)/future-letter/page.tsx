...
export default function FutureLetterPage() {
 ...
 {myPending && (
 <div className="mb-6 flex items-start gap-3 px-4 py-3 bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800">
 ...
 <Textarea
 placeholder="En 1 mes quiero haber logrado..."value={text}
...
"text-xs",
 ...
 <Card
 key={l.id}
 className="transition-all duration-300 hover:border-primary/30 border-dashed">
 ...
 <div className="mt-3 bg-accent/40 p-4 flex items-center justify-center gap-2 text-muted-foreground">
 <Lock className="w-4 h-4"/>
