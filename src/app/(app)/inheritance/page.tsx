            ...
            {myDesignation ? (
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Badge
                    variant="secondary"
                    className="bg-amber-500/10 text-amber-700 border border-amber-500/20 text-lg font-mono tabular-nums px-3 py-1"
                  >
                      ...
                      <div className="flex items-center gap-2">
                        <div className="w-24 h-2 bg-accent/30 border border-border overflow-hidden">
                          <div
                            ...
                            style={{ width: `${inheritor.percentage}%` }}
                          />
                        </div>
                        <Badge
                          variant="outline"
                          className="border-amber-500/30 text-amber-700 font-mono tabular-nums text-xs"
                        >
