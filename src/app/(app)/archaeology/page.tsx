      ...
      <div className="flex items-center justify-center h-screen">
        <div className="flex flex-col items-center gap-4">
          <div className="relative">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-amber-500 to-amber-700 animate-pulse" />
            <Pickaxe className="w-6 h-6 text-white absolute top-3 left-3 animate-bounce" />
          </div>
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="grid grid-cols-3 gap-3 mb-8 mt-6">
        <div className="bg-amber-50/60 dark:bg-amber-950/20 rounded-xl p-3 text-center border border-amber-200/30 dark:border-amber-800/20">
                    ...
                    <div className="flex flex-col items-center gap-1 min-w-[40px]">
                      <div
                        className={cn(
                          ...
                          fossil.severity === "high"
                            ? "bg-red-100 dark:bg-red-900/30"
                            : fossil.severity === "medium"
