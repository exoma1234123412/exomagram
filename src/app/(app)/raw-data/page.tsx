    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={loadData}
            className="p-1.5 hover:bg-accent/30 transition-colors border border-border/40"
            title="Refrescar"
          >
      ...
      {stats && (
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 mb-6">
          <div className="bg-accent/30 border border-border p-3">
            <div className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground/40 mb-1">Total Filas</div>
            <div className="font-mono text-lg tabular-nums tracking-tight">{stats.totalRows.toLocaleString()}</div>
          </div>
          <div className="bg-accent/30 border border-border p-3">
            <div className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground/40 mb-1">Rango Fechas</div>
            <div className="font-mono text-[11px] tabular-nums tracking-tight">{stats.dateRangeStr}</div>
          </div>
          <div className="bg-accent/30 border border-border p-3">
            <div className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground/40 mb-1">Filas / Persona</div>
            <div className="font-mono text-lg tabular-nums tracking-tight">{stats.rowsPerPerson}</div>
          </div>
          <div className="bg-accent/30 border border-border p-3">
            <div className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground/40 mb-1">Filas / Día</div>
            ...
            <tr>
              {tabConfig.columns.map((col) => (
                <th
                  ...
                  className={cn(
                    "font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground/40 bg-accent/20",
                      ...
                      >
                        {showRelative ? (
                          <span className="flex flex-col">
                            ...
                            <span className="text-[8px] text-muted-foreground/50">hace {timeAgo(val as string)}</span>
                          </span>
                        ) : (
                          display
                        )}
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-between">
          <div className="font-mono text-[10px] text-muted-foreground/50 tabular-nums">
      ...
      <div className="mt-6 flex items-center justify-center gap-2">
        ...
        <span className="font-mono text-[8px] tracking-[0.2em] text-muted-foreground/30 uppercase">
