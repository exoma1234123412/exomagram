...
"flex items-center gap-3 px-3 py-2 transition-all",
 ...
 <Avatar className="w-8 h-8 ring-2 ring-background border border-white/20">
 ...
 {recentEntry && (
 <div className="mb-4 animate-pulse bg-blue-600/20 border border-blue-500/30 p-4">
 ...
 return (
 <div key={entry.id} className="flex items-center gap-4 px-4 py-3 bg-white/[0.03] hover:bg-white/[0.06] transition-colors">
 <Avatar className="w-8 h-8 ring-2 ring-background border border-white/10">
