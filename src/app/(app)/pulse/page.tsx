  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="flex items-center justify-center mb-8">
        <div className="relative flex items-center gap-4 bg-black/90 dark:bg-black/70 rounded-2xl px-8 py-5 border border-green-500/20">
          <Heart
            className={cn(
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        {/* Ritmo Cardiaco */}
        <div className="bg-black/90 dark:bg-black/60 rounded-xl p-4 border border-green-500/20 transition-all duration-300">
        ...
        <div className="bg-black/90 dark:bg-black/60 rounded-xl p-4 border border-green-500/20 transition-all duration-300">
          ...
          <p className="text-[10px] text-green-400/40 mt-1">
            {avgMood !== null
              ? MOOD_LABELS[Math.round(avgMood) as MoodLevel] ?? "Animo promedio"
              : "Sin datos de animo"}
          </p>
        </div>
      </div>
      ...
      <Card
        className={cn(
          "mb-8 overflow-hidden transition-all duration-300 hover:shadow-lg hover:shadow-primary/5",
          "border",
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <div className="flex items-center gap-2 mb-1">
                ...
                <Badge
                  variant="outline"
                  className={cn("text-[10px]", diagnosisConfig.color)}
                >
