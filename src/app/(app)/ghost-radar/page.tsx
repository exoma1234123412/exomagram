                    ...
                    <div className="flex items-start gap-4 sm:gap-5">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1 flex-wrap">
                          ...
                          <Badge
                            variant="secondary"
                            className="font-mono text-[9px] bg-accent/30 border border-border text-muted-foreground"
                          >
                            {haunt.label}
                          </Badge>
                        </div>
                        ...
                        <div className="mb-3">
                          <p className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground/40 mb-1.5">
                              ...
                              <div key={i} className="flex flex-col items-center gap-1">
                                <div
                                  className={cn(
                                    ...
                                    active
                                      ? "bg-green-200 dark:bg-green-800/60 border-green-300 dark:border-green-700"
                      ...
                      <div className="shrink-0">
                        <Button
                          size="sm"
                          variant={nudged.has(ghost.userId) ? "secondary" : "default"}
                          className={cn(
              ...
              >
                <CardContent className="p-3 sm:p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[10px] font-mono text-muted-foreground">
                        {member.daysInactive === 0
                          ? "Activo hoy"
                          : `Hace ${member.daysInactive} dia${member.daysInactive !== 1 ? "s" : ""}`}
                      </p>
                    </div>
                    ...
                    <Badge
                      variant="secondary"
                      className="font-mono text-[9px] tabular-nums bg-accent/30 border border-border text-muted-foreground shrink-0"
                    >
