      ...
      <Card className="mb-8 border-2">
        <CardContent className="p-6">
          ...
          <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                {teamMembers.map((m) => (
                  <button
                    ...
                    className={cn(
                      "flex items-center gap-2 p-2.5 rounded-xl transition-all duration-200 text-left",
              ...
              <div className="flex flex-wrap gap-2">
                {POINT_OPTIONS.map((p) => (
                  <button
                    ...
                    className={cn(
                      "w-10 h-10 rounded-xl text-sm font-bold transition-all duration-200 tabular-nums",
                      selectedPoints === p
            ...
            <Button
              className="rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 text-white border-0 shadow-lg shadow-blue-600/25 gap-2 w-full"
