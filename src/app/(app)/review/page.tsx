...
export default function ReviewPage() {
 ...
 : null;
 const TrajIcon =
 review?.trajectory?.direction ==="improving"? TrendingUp
 : review?.trajectory?.direction ==="declining"? TrendingDown
 : Minus;
 const trajColor =
 review?.trajectory?.direction ==="improving"?"text-green-600": review?.trajectory?.direction ==="declining"?"text-red-600":"text-muted-foreground";
...
"text-2xl font-bold tabular-nums",
 ...
 ?"text-green-600": review.key_metrics.evidence_percent >= 50
...
"text-2xl font-bold tabular-nums",
 ...
 {/* Strengths */}
 <Card className="transition-all duration-300 hover:border-primary/30 border-green-200/50 dark:border-green-900/50">
 <CardHeader className="pb-2">
 ...
 <div
 key={i}
 className="p-3 bg-green-500/5 border border-green-500/10">
 ...
 <Card className="transition-all duration-300 hover:border-primary/30 border-orange-200/50 dark:border-orange-900/50">
 <CardHeader className="pb-2">
 ...
 <div
 key={i}
 className="p-3 bg-orange-500/5 border border-orange-500/10">
...
"text-2xl font-bold tabular-nums",
 ...
 ?"text-green-600": review.reliability_score.ratio_percent >= 50
 ?"text-yellow-600":"text-red-600")}
 >
 ...
 className={cn(
"text-xs border",
 review.trajectory.direction ==="improving"?"bg-green-50 dark:bg-green-950/30 text-green-700 dark:text-green-400 border-green-300 dark:border-green-800": review.trajectory.direction ==="declining"?"bg-red-50 dark:bg-red-950/30 text-red-700 dark:text-red-400 border-red-300 dark:border-red-800":"bg-accent text-muted-foreground border-border")}
 >
 {review.trajectory.direction ==="improving"?"Mejorando": review.trajectory.direction ==="declining"?"Declinando":"Estable"}
 </Badge>
 <Badge
 className={cn(
"text-xs border",
 ...
 <Card
 className={cn(
"transition-all duration-300 hover:border-primary/30 border-2",
 review.recommendation ==="promote"?"border-green-300 dark:border-green-800": review.recommendation ==="warning"?"border-red-300 dark:border-red-800": review.recommendation ==="concern"?"border-yellow-300 dark:border-yellow-800":"border-border")}
 >
 <CardContent className="p-6">
 <div className="flex items-center gap-3 mb-2">
