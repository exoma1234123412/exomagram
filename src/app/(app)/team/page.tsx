...
"postgres_changes",
 ...
 <Input
 placeholder="Buscar por nombre, email o rol..."value={searchQuery}
 ...
 <div
 key={item.key}
 className="bg-accent/40 p-2.5 text-center">
 ...
 {searchQuery
 ?"No se encontraron miembros con ese filtro.":"No hay miembros en el equipo todav\u00eda."}
 </p>
 </div>
 ) : (
...
"text-base font-bold tabular-nums tracking-tight",
 ...
 {/* Streak */}
 <div className="bg-accent/40 px-2 py-1.5 text-center">
...
"h-full rounded-full transition-all duration-500",
 hoursPercent >= 100
 ?"bg-green-500": hoursPercent >= 50
 ?"bg-blue-500": hoursPercent > 0
 ?"bg-yellow-500":"bg-gray-300 dark:bg-gray-600")}
 ...
 <span>
 {m.lastActivity
 ?`\u00daltima actividad: Hace ${timeAgo(m.lastActivity)}`:"Sin actividad hoy"}
 </span>
 </div>
 ...
 <Button
 variant="outline"size="sm"className="flex-1 text-xs h-8"render={<Link href={`/deep-profile/${m.userId}`} />}
 >
