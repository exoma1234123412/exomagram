...
export default function GoalsPage() {
 ...
 {activeGoals.map((g) => (
 <Card key={g.id} className="transition-all duration-300 hover:border-primary/30">
 ...
 <div
 className="h-full bg-emerald-500 rounded-full transition-all duration-500"style={{ width:`${g.progress}%`}}
 />
 </div>
 </div>
 </div>
 ...
 <Label>Título</Label>
 <Input
 placeholder="Ej: Completar el módulo de pagos"value={title}
 ...
 <Textarea
 placeholder="Más detalle..."value={description}
 ...
 <Input
 type="number"placeholder="20"value={targetHours}
