...
"postgres_changes",
 ...
 <p className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground">Invertido</p>
 <p className="text-xl font-mono font-bold tabular-nums tracking-tight mt-1">{totalInvested}</p>
 </div>
 <div className="bg-accent/30 border border-border p-4">
 <p className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground">Valor actual</p>
...
"bg-accent/30 border border-border p-4",
 ...
 <p className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground">Ganancia</p>
 <p className={cn(
...
"font-mono tabular-nums text-[10px]",
 ...
 <Button
 variant="outline"size="sm"className="font-mono text-xs text-red-600 border-red-600/30 hover:bg-red-600/10 hover:border-red-600/50"onClick={() => setSellItem(item)}
 >
 Vender
 </Button>
 </div>
...
"w-[4px] transition-all",
 isLast
 ? stock.trend >= 0
 ?"bg-green-500":"bg-red-500":"bg-muted-foreground/20")}
...
"font-mono text-xs gap-1",
 hasActiveInvestment
 ?"bg-primary/10 text-primary border border-primary/30 hover:bg-primary/20":"bg-primary text-primary-foreground")}
 onClick={() => {
 setBuyTarget(stock);
 setBuyAmount(25);
 }}
 ...
 <CandlestickChart className="w-8 h-8 text-muted-foreground"/>
 </div>
...
"w-12 h-10 font-mono text-sm font-bold transition-all duration-200 tabular-nums border",
 buyAmount === amt
 ?"bg-primary text-primary-foreground border-primary":"bg-accent/30 text-muted-foreground border-border hover:border-primary/30")}
 >
 {amt}
 </button>
 ))}
 ...
 <DialogFooter>
 <Button
 variant="outline"onClick={() => setBuyTarget(null)}
 className="font-mono text-xs">
 Cancelar
 </Button>
 <Button
 className="bg-primary text-primary-foreground font-mono text-xs gap-1"disabled={buying || buyAmount < 1 || buyAmount > 100}
 onClick={handleBuy}
 >
 {buying ? (
...
"font-mono font-bold tabular-nums",
 ...
 <DialogFooter>
 <Button
 variant="outline"onClick={() => setSellItem(null)}
 className="font-mono text-xs">
 Cancelar
 </Button>
 <Button
 className="font-mono text-xs gap-1 bg-red-600 text-white hover:bg-red-700"disabled={selling}
 onClick={handleSell}
 >
 {selling ? (
 <Loader2 className="w-3.5 h-3.5 animate-spin"/>
