...
function SectionLabel({ children }: { children: React.ReactNode }) {
 ...
 <h2 className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground border-b border-border pb-2">
 {children}
 </h2>
 </div>
 );
...
export default function DeepProfilePage() {
 ...
 {/* Back link */}
 <Link
 href="/team"className="inline-flex items-center gap-1 text-xs font-mono text-muted-foreground hover:text-foreground mb-8 uppercase tracking-wider">
...
"absolute -bottom-1 -right-1 w-5 h-5 rounded-full border-2 border-background",
 ...
 <p className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground">Trust Score</p>
...
"w-[2px] transition-all",
 ...
 <div className="text-right">
 <p className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground">Shame Score</p>
...
"font-mono text-lg font-bold tabular-nums tracking-tight",
 ...
 <p className="font-mono text-[9px] tracking-[0.12em] uppercase text-muted-foreground mt-1">
 {stat.label}
 </p>
 </div>
 ))}
...
"w-[12px] h-[12px] transition-colors cursor-default",
 ...
 <p className="font-mono text-xs text-muted-foreground uppercase">Sin entradas</p>
 </div>
 ) : (
 ...
 key={i}
 href={url}
 target="_blank"rel="noopener noreferrer"className="font-mono text-[9px] text-primary hover:underline flex items-center gap-0.5">
...
"w-full transition-all",
 ...
 <div
 className="w-full bg-primary/60 transition-all"style={{ height:`${(count / patterns.maxHour) * 64}px`, minHeight:"2px"}}
 />
 <span className="font-mono text-[7px] tabular-nums text-muted-foreground">
 {hour}
 </span>
...
"w-full transition-all",
 ...
 <div
 className="w-full bg-primary/40 transition-all"style={{ height:`${(avg / maxAvg) * 56}px`, minHeight: avg > 0 ?"2px":"0"}}
 />
 </div>
 );
 })}
 ...
 <p className="font-mono text-[9px] text-muted-foreground">Sin datos</p>
 )}
 </div>
 </div>
 ...
 <p className="font-mono text-[9px] text-muted-foreground text-center py-4 uppercase">
...
"hover:opacity-80")}
 ...
 <p className="font-mono text-[8px] text-muted-foreground uppercase">{info.label}</p>
 </div>
 );
 })}
 </div>
 ...
 <p className="font-mono text-[9px] text-muted-foreground uppercase">Sin flags</p>
 </div>
 ) : (
 flags.map((flag) => {
...
"text-[8px] px-1 py-0 h-3.5",
 flag.resolved
 ?"text-green-600 border-green-300 dark:border-green-700":"text-red-600 border-red-300 dark:border-red-700")}
 >
 ...
 <p className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground mb-1">Racha actual</p>
 ...
 <p className="font-mono text-[9px] text-muted-foreground mt-0.5">dias</p>
 </div>
 <div className="bg-background p-4 text-center">
 <p className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground mb-1">Mejor racha</p>
 ...
 <div className="bg-background p-4 text-center">
 <p className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground mb-1">Dias registrados</p>
 <p className="font-mono text-2xl font-black tabular-nums tracking-tight">
 {streak?.total_days_logged ?? 0}
 </p>
 <p className="font-mono text-[9px] text-muted-foreground mt-0.5">total</p>
 </div>
 </div>
...
"font-mono text-lg font-bold tabular-nums",
 ...
 <p className="font-mono text-[8px] text-muted-foreground uppercase">{type}</p>
 </div>
 );
 })}
 </div>
 ...
 {closeouts.length === 0 ? (
 <div className="p-6 text-center">
 <p className="font-mono text-[9px] text-muted-foreground uppercase">Sin closeouts</p>
 </div>
 ) : (
 ...
 {standups.length === 0 ? (
 <div className="p-6 text-center">
 <p className="font-mono text-[9px] text-muted-foreground uppercase">Sin standups</p>
 </div>
 ) : (
 ...
 <span className="text-muted-foreground">AYER:</span> {s.yesterday}
 </p>
 <p className="font-mono text-[10px]">
 <span className="text-muted-foreground">HOY:</span> {s.today_plan}
 </p>
 {s.blockers && (
 <p className="font-mono text-[10px] text-red-500/70">
 <span className="text-muted-foreground">BLOCKER:</span> {s.blockers}
 </p>
 )}
 </div>
 </div>
