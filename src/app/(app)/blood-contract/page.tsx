    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="grid grid-cols-4 gap-3 mb-8">
        <div className="bg-accent/30 border border-border p-3 text-center">
          ...
          <p className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground/40">Activos</p>
        </div>
        <div className="bg-accent/30 border border-border p-3 text-center">
          <p className="text-xl font-mono font-bold tabular-nums tracking-tight">{pendingForMe.length}</p>
          <p className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground/40">Pendientes</p>
        </div>
        <div className="bg-accent/30 border border-border p-3 text-center">
          <p className="text-xl font-mono font-bold tabular-nums tracking-tight text-green-600">{completedContracts.length}</p>
          <p className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground/40">Completados</p>
        </div>
        <div className="bg-accent/30 border border-border p-3 text-center">
          <p className="text-xl font-mono font-bold tabular-nums tracking-tight text-red-600">{brokenContracts.length}</p>
          <p className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground/40">Rotos</p>
        </div>
      </div>
      ...
      {pendingForMe.length > 0 && (
        <section className="mb-8">
          <p className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground/40 mb-3 flex items-center gap-2">
          ...
          <Card className="border-red-600/30 border-2">
            <CardContent className="p-5">
              ...
              <div className="space-y-4">
                {/* Opponent */}
                <div>
                  <label className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground/40 mb-2 block">
                    Contraparte
                  </label>
                ...
                <div>
                  ...
                  <Textarea
                    placeholder="Describe exactamente a que se compromete cada parte..."
                    value={terms}
    ...
    <Card className="border-amber-600/30 border-2 transition-colors duration-200 hover:border-amber-600/50">
      <CardContent className="p-4">
        ...
        <div className="flex gap-2">
          <Button
            onClick={onSign}
            className="flex-1 font-mono text-[10px] uppercase tracking-wider bg-red-600 hover:bg-red-700 text-white border-0 gap-1"
            size="sm"
          >
            <Droplets className="w-3 h-3" />
            Firmar con Sangre
      ...
      <CardContent className="p-4">
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          <span className={cn(
            ...
            {isExpired
              ? "EXPIRADO"
              : formatDistanceToNow(deadlineDate, { addSuffix: false, locale: es }) + " restante"
            }
          </span>
        </div>
        ...
        <div className="flex items-center gap-3 mb-3">
          <div className="flex items-center gap-2 flex-1 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="font-mono text-[8px] text-muted-foreground/40 uppercase tracking-wider">Creador</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 flex-1 min-w-0 justify-end text-right">
            <div className="min-w-0">
              ...
              <p className="font-mono text-[8px] text-muted-foreground/40 uppercase tracking-wider">Contraparte</p>
            </div>
            <Avatar className="w-9 h-9 ring-1 ring-red-600/30">
        ...
        {isParty && (
          <div className="flex gap-2 pt-3 border-t border-border/50">
            <Button
              ...
              size="sm"
              className="flex-1 font-mono text-[10px] uppercase tracking-wider bg-green-600 hover:bg-green-700 text-white border-0 gap-1"
            >
            ...
            <Button
              ...
              variant="outline"
              size="sm"
              className="flex-1 font-mono text-[10px] uppercase tracking-wider gap-1 text-red-600 border-red-600/30 hover:bg-red-600/10"
            >
