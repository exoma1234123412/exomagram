...
export default function MatrixPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-2 sm:px-4 py-8">
        ...
        <table className="w-full border-collapse text-[10px] font-mono">
          ...
          <thead>
            <tr className="sticky top-0 z-20 bg-background">
              <th
                className="sticky left-0 z-30 bg-background border border-border px-2 py-2 text-left font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground/40 min-w-[200px] w-[200px]"
              >
                Metrica
              </th>
              {members.map((m) => (
              ...
              <th className="border border-border px-2 py-2 text-center min-w-[80px]">
                <span className="font-mono text-[9px] tracking-[0.18em] uppercase text-muted-foreground/40 font-bold">
                  Equipo
                </span>
              </th>
            </tr>
      ...
      {/* Footer note */}
      <div className="mt-4 text-[9px] font-mono text-muted-foreground/40 tracking-wide">
