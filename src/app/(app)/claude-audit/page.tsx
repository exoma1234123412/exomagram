...
export default function ClaudeAuditPage() {
 ...
 <p className="text-xs text-muted-foreground">Esto toma 10-20 segundos</p>
 </div>
 )}
 ...
 <div className={cn(
"w-16 h-16 flex items-center justify-center text-2xl font-bold shrink-0",
...
"bg-red-100 dark:bg-red-900/30 text-red-700")}>
 ...
 <div className="p-3 bg-green-50 dark:bg-green-950/15">
 ...
 <div className="p-3 bg-red-50 dark:bg-red-950/15">
 ...
 {data.recommendation && (
 <div className="mt-4 p-3 bg-primary/5">
 ...
 <div className="mb-3 p-3 bg-red-100 dark:bg-red-950/25 border border-red-300 dark:border-red-700">
 ...
 <div className="mb-3 p-3 bg-red-50 dark:bg-red-950/15 border border-red-200/50 dark:border-red-800/30">
