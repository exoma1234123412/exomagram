        ...
        <div className="space-y-4 py-2">
          ...
          <div className="space-y-3">
            ...
            {[
              ...
              <label
                key={pref.id}
                className="flex items-start gap-3 cursor-pointer p-2 rounded-lg hover:bg-accent/40 transition-colors"
              >
                <input
                  type="checkbox"
                  checked={pref.value}
                ...
                <button
                  ...
                  className={cn(
                    ...
                    active
                      ...
                      : "bg-muted/50 text-muted-foreground border-border hover:bg-accent/60"
                  )}
                >
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-1.5">
            {deliveries.map((d) => (
              <div
                key={d.id}
                className="flex items-center gap-3 px-3 py-2 rounded-lg bg-accent/30 text-sm"
              >
                <span
                  className={cn(
...
function ApiKeysSection({
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-5">
        {/* Rate limit info */}
        <div className="flex gap-3 p-3 bg-accent/30 rounded-xl">
          ...
          <div className="space-y-2">
            {keys.map((k) => {
              ...
              return (
                <div
                  key={k.id}
                  className="flex items-center gap-2 p-3 rounded-xl border border-border/50 bg-accent/20"
                >
