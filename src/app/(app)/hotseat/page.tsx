...
export default function HotSeatPage() {
 ...
 <p className="text-xs text-muted-foreground">Esto toma 15-30 segundos</p>
 </div>
 )}
 ...
 <div className={cn("w-20 h-20 flex flex-col items-center justify-center shrink-0", gs.bg)}>
 ...
 <div className="p-3 bg-accent/40 text-center">
 <p className={cn("text-2xl font-bold", gs.color)}>{data.overall_score}</p>
 <p className="text-[10px] text-muted-foreground">Score</p>
 </div>
 <div className="p-3 bg-accent/40 text-center">
 <p className="text-2xl">{data.trajectory ==="improving"?"UP": data.trajectory ==="declining"?"DN":"--"}</p>
 <p className="text-[10px] text-muted-foreground">Trayectoria</p>
 </div>
 <div className="p-3 bg-accent/40 text-center">
 <p className="text-2xl">{data.survivability?.toLowerCase().startsWith("sí") ?"OK":"❌"}</p>
