    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="flex justify-center mb-8">
        <button
          ...
          className={cn(
            ...
            hasActivePanic
              ? "bg-red-900/30 border-4 border-red-800/40 cursor-not-allowed opacity-60"
              : "bg-gradient-to-br from-red-500 to-red-700 border-4 border-red-400/50 shadow-2xl shadow-red-600/40 hover:shadow-red-500/60 hover:scale-105 active:scale-95 animate-pulse-glow cursor-pointer"
          )}
        >
          <div className={cn(
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="rounded-2xl sm:max-w-md">
          ...
          <div className="py-2">
            <Input
              placeholder="Estoy bloqueado con... (opcional)"
              value={reason}
          ...
          <DialogFooter>
            ...
            <Button
              onClick={handlePanic}
              disabled={submitting}
              className="rounded-xl bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white border-0 shadow-lg shadow-red-600/25"
            >
          ...
          <div className="space-y-4">
            {activeEvents.map((event) => {
              ...
              return (
                <Card
                  key={event.id}
                  className="border-2 border-red-500/40 bg-red-500/5 transition-all duration-300 hover:shadow-lg hover:shadow-red-500/10"
                >
                  <CardContent className="p-5">
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex items-start gap-3">
                        <Avatar className="w-10 h-10 ring-2 ring-red-500/30 shadow-sm">
                      ...
                      <div className="text-right flex flex-col items-end gap-2">
                        ...
                        {event.user_id !== userId && (
                          <Button
                            ...
                            size="sm"
                            className="rounded-xl bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white border-0 shadow-lg shadow-green-600/25"
                          >
                        ...
                        <div className="space-y-1.5">
                          {userEntries.map((entry) => {
                            ...
                            return (
                              <div
                                key={entry.id}
                                className="flex items-center gap-2 text-sm bg-accent/30 rounded-lg px-3 py-1.5"
                              >
                                <span>{cat?.emoji}</span>
