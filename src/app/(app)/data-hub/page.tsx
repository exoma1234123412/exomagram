  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
      ...
      <section className="mb-8">
        <div className="palantir-divider mb-4 text-muted-foreground/40">
        ...
        <div className="corner-marks border border-border bg-grid-palantir p-6 flex flex-col items-center justify-center gap-2">
          <span className="label-mono text-muted-foreground/50">Data Score</span>
          ...
          {sources.map((s) => (
            ...
            >
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  {s.lastDate && (
                    <span className="data-cell text-muted-foreground/40">
        ...
        {entries.length === 0 ? (
          ...
          <div className="border border-border divide-y divide-border">
            ...
            <div className="grid grid-cols-[1fr_80px_1fr_60px] gap-2 px-4 py-2 bg-accent/20">
              <span className="label-mono text-muted-foreground/50">Campo</span>
              <span className="label-mono text-muted-foreground/50 text-right">Tasa</span>
              <span className="label-mono text-muted-foreground/50">Barra</span>
              <span className="label-mono text-muted-foreground/50 text-right">N</span>
            </div>
            {fieldCompletions.map((fc) => (
              ...
              >
                ...
                <span className="data-cell text-muted-foreground/50 text-right">
                  {fc.filled}/{fc.total}
                </span>
              </div>
            ))}
              ...
              {dailyTrend.map((d, i) => {
                ...
                return (
                  <div
                    ...
                    title={`${format(new Date(d.date + "T12:00:00"), "dd MMM", { locale: es })}: ${d.completeness}%`}
                  >
                    <div
                      className={cn(
              ...
              <div
                ...
                className={cn(
                  ...
                  r.priority === "high"
                    ...
                    : r.priority === "medium"
                      ? "border-amber-500 text-foreground/80"
