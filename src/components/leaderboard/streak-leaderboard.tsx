...
export function StreakLeaderboard({ orgId }: { orgId: string }) {
 ...
 key={e.profile.id}
 className={cn(
"relative flex items-center gap-3 p-2.5 transition-all duration-500",
 ...
 <div
 className="absolute left-0 top-0 bottom-0 bg-orange-100/50 dark:bg-orange-900/10 transition-all duration-1000 ease-out"style={{ width:`${barWidth}%`}}
 />
