...
export function ForcedComparison() {
 ...
 {/* Backdrop */}
 <div
 className="absolute inset-0 bg-black/80 backdrop-blur-sm"onClick={() => canDismiss && setVisible(false)}
 />
...
"border p-4",
 belowAverage
 ?"border-red-500/30 bg-red-500/5":"border-emerald-500/30 bg-emerald-500/5")}
 >
 <p className="text-[9px] tracking-[0.18em] uppercase text-muted-foreground mb-2">
 Tu llevas
 </p>
