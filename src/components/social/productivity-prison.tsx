...
function PrisonOverlay({
 ...
 {/* Scanline effect */}
 <div
 className="fixed inset-0 z-[91] pointer-events-none opacity-[0.03]"style={{
 backgroundImage:
...
"bg-red-950/20")}
 ...
 <div
 className="h-full bg-gradient-to-r from-red-600 to-red-400 transition-all duration-700"style={{ width:`${progressPercent}%`}}
 />
 </div>
