...
"pointer-events-auto border bg-card p-3 max-w-sm animate-ticker-in",
 n.variant ==="shame"?"border-red-500/30":"border-amber-500/30",
 )}
 style={{
...
"size-3.5 mt-0.5 shrink-0",
 n.variant ==="shame"?"text-red-500":"text-amber-500",
 )}
 />
 <span
 className="font-mono text-[11px] leading-snug text-foreground flex-1"dangerouslySetInnerHTML={{ __html: n.message }}
 />
 <button
