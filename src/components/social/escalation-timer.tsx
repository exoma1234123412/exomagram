...
"absolute bottom-0 left-0 right-0 h-px",
 escalationLevel === 3
 ?"bg-red-600/80 shadow-[0_0_8px] shadow-red-600/40":"bg-red-500/50")} />
 )}
...
"text-[11px] uppercase tracking-wide leading-tight",
 ...
 {escalationLevel < 2
 ?"Si no registras, se enviará una alerta al equipo completo con tu nombre": escalationLevel < 3
 ?"Alerta al equipo en minutos — registra ahora":"ALERTA INMINENTE — REGISTRA AHORA"}
 </span>
 </div>
...
"border transition-all duration-200",
 escalationLevel < 2
 ?"border-amber-500/50 text-amber-700 dark:text-amber-300 hover:bg-amber-500/10":"border-red-500/50 text-red-700 dark:text-red-300 hover:bg-red-500/10",
