...
"animate-in slide-in-from-bottom-4 fade-in duration-300")}
 ...
 <div
 className={cn(
"flex items-center gap-3 border border-border/60",
"bg-card/95 p-3 backdrop-blur-md")}
 >
 ...
 <Button
 variant="ghost"size="icon-sm"onClick={handleDismiss}
 aria-label="Cerrar">
 <X className="h-4 w-4"/>
 </Button>
 <Button size="sm"onClick={handleInstall} className="">
