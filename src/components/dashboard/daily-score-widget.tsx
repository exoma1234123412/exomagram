...
export function DailyScoreWidget({ orgId }: { orgId: string }) {
 ...
 <circle cx="32"cy="32"r="28"fill="none"strokeWidth="3"className={scoreColor}
 ...
 <span className="text-[9px] font-mono text-muted-foreground uppercase tracking-wider">evidencia</span>
 </div>
 ...
 <span className="text-[9px] font-mono text-muted-foreground uppercase tracking-wider">Standup</span>
 </div>
 ...
 <span className="text-[9px] font-mono text-muted-foreground uppercase tracking-wider">Cierre</span>
 </div>
 </div>
