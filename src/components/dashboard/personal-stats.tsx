...
export function PersonalStatsWidget({ orgId, date }: { orgId: string; date: string }) {
 ...
 {/* Hours today */}
 <Card className="group/stat hover:border-primary/30 transition-all duration-300 overflow-hidden relative">
 <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-transparent"/>
 <CardContent className="p-4 text-center relative">
 <div className="w-8 h-8 bg-primary/10 dark:bg-primary/15 flex items-center justify-center mx-auto mb-2">
...
"text-2xl font-bold tabular-nums tracking-tight",
 ...
 <div
 className="h-full bg-gradient-to-r from-blue-500 to-blue-600 rounded-full transition-all duration-500"style={{ width:`${hoursProgress}%`}}
 />
 </div>
 {hoursDelta !== 0 && (
 ...
 {/* Proof rate */}
 <Card className="group/stat hover:shadow-green-500/5 transition-all duration-300 overflow-hidden relative">
 <div className="absolute inset-0 bg-gradient-to-br from-green-500/5 to-transparent"/>
 <CardContent className="p-4 text-center relative">
 <div className="w-8 h-8 bg-green-100 dark:bg-green-900/30 flex items-center justify-center mx-auto mb-2">
...
"text-2xl font-bold tabular-nums tracking-tight",
 ...
 {/* Trust score */}
 <Card className="group/stat hover:shadow-blue-500/5 transition-all duration-300 overflow-hidden relative">
 <div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 to-transparent"/>
 <CardContent className="p-4 text-center relative">
 <div className={cn(
"w-8 h-8 flex items-center justify-center mx-auto mb-2",
...
"text-2xl font-bold tabular-nums tracking-tight",
 ...
 {/* Streak */}
 <Card className="group/stat hover:shadow-orange-500/5 transition-all duration-300 overflow-hidden relative">
