...
export function DailyChallenge({ orgId }: { orgId: string }) {
 ...
 return (
 <Card className={cn(
"mb-8 transition-all duration-300 hover:border-primary/30",
 myCompleted
 ?"border-green-300 dark:border-green-700 bg-green-50/50 dark:bg-green-950/10":"border-yellow-200 dark:border-yellow-800 bg-yellow-50/30 dark:bg-yellow-950/10")}>
