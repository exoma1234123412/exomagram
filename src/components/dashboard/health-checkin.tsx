...
function RatingButtons({
 ...
 <button
 key={n}
 type="button"onClick={() => onChange(n)}
...
export function HealthCheckin({ orgId }: { orgId: string }) {
 ...
 <p className="font-mono text-[8px] text-muted-foreground uppercase">Sueno</p>
 </div>
 )}
 ...
 <p className="font-mono text-[8px] text-muted-foreground uppercase">Ejercicio</p>
 </div>
 )}
 ...
 <p className="font-mono text-[8px] text-muted-foreground uppercase">Agua</p>
 </div>
 )}
 ...
 <p className="font-mono text-[8px] text-muted-foreground uppercase">Claridad</p>
 </div>
 )}
 ...
 <p className="font-mono text-[8px] text-muted-foreground uppercase">Motivacion</p>
 </div>
 )}
 </div>
 </div>
 ...
 <span className="font-mono text-[10px] uppercase text-muted-foreground">Sueno</span>
 </div>
 <Input
 type="number"min={0}
 max={24}
 step={0.5}
 placeholder="h"value={sleepHours}
 ...
 <span className="font-mono text-[10px] uppercase text-muted-foreground">Ejercicio</span>
 </div>
 <Input
 type="number"min={0}
 max={300}
 placeholder="min"value={exerciseMinutes}
 ...
 <span className="font-mono text-[10px] uppercase text-muted-foreground">Hidratacion</span>
 </div>
 ...
 <span className="font-mono text-[10px] uppercase text-muted-foreground">Comidas</span>
 </div>
 <Input
 type="number"min={0}
 max={10}
 ...
 <span className="font-mono text-[10px] uppercase text-muted-foreground">Estres</span>
 </div>
 ...
 <span className="font-mono text-[10px] uppercase text-muted-foreground">Claridad</span>
 </div>
 ...
 <span className="font-mono text-[10px] uppercase text-muted-foreground">Motivacion</span>
 </div>
 ...
 <span className="font-mono text-[10px] uppercase text-muted-foreground">Pantalla</span>
 <Input
 type="number"min={0}
 max={24}
 step={0.5}
 placeholder="h"value={screenTime}
 onChange={(e) => setScreenTime(e.target.value)}
 className="font-mono text-xs w-16 h-7 px-2"/>
 </div>
 <div className="flex items-center gap-1.5">
 <Coffee className="w-3 h-3 text-muted-foreground"/>
 <span className="font-mono text-[10px] uppercase text-muted-foreground">Descansos</span>
 <Input
 type="number"min={0}
 max={20}
 placeholder="#"value={breaks}
 ...
 <input
 type="checkbox"checked={overtime}
 onChange={(e) => setOvertime(e.target.checked)}
 className="accent-primary"/>
 <span className="font-mono text-[10px] uppercase text-muted-foreground">Overtime</span>
 </label>
 <label className="flex items-center gap-1.5 cursor-pointer">
 <input
 type="checkbox"checked={personalIssues}
 onChange={(e) => setPersonalIssues(e.target.checked)}
 className="accent-primary"/>
 <span className="font-mono text-[10px] uppercase text-muted-foreground">Problemas personales</span>
 </label>
 </div>
