...
function StreakThreat({
  ...
  return (
    <div className="flex items-center gap-3 p-3.5 rounded-2xl bg-orange-50/90 dark:bg-orange-950/25 border border-orange-300/60 dark:border-orange-700/50 shadow-sm shadow-orange-500/10 animate-pulse">
...
export function UrgencyEngine() {
  ...
  const fetchData = useCallback(async () => {
    ...
    const urgencyLevel =
      myHoursLogged >= EXPECTED_DAILY_HOURS
        ? "none"
        : getUrgencyLevel(decimalHour, myHoursLogged);
  ...
  function renderAggressive() {
    return (
      <Card className="border-amber-300/60 dark:border-amber-700/50 bg-amber-50/70 dark:bg-amber-950/15 shadow-sm shadow-amber-500/10">
        <CardContent className="flex flex-col gap-3">
          <div className="flex items-center gap-3">
  ...
  function renderCritical() {
    return (
      <div className="rounded-2xl border-2 border-red-400/70 dark:border-red-600/60 bg-red-50 dark:bg-red-950/30 p-4 shadow-md shadow-red-500/15">
        <div className="flex items-start gap-3">
          <div className="w-10 h-10 rounded-xl bg-red-100 dark:bg-red-900/50 flex items-center justify-center shrink-0 animate-pulse">
              ...
              <div className="mt-2 flex flex-wrap gap-1.5">
                {finishedPeople.slice(0, 5).map((p) => (
                  <Badge
                    key={p.userId}
                    variant="secondary"
                    className="text-[11px] bg-red-100/80 dark:bg-red-900/30 text-red-700 dark:text-red-300"
                  >
  ...
  function renderFinal() {
    return (
      <div className="rounded-2xl border-2 border-red-500 dark:border-red-600 bg-red-600 dark:bg-red-900 p-5 shadow-lg shadow-red-600/30 w-full">
        <div className="flex items-center gap-4">
          ...
          <div className="shrink-0 flex flex-col items-center">
            <Timer className="w-7 h-7 text-white animate-bounce" />
  ...
  function renderShame() {
    ...
    return (
      <div className="rounded-2xl border-2 border-red-800/60 dark:border-red-700/50 bg-red-950 dark:bg-red-950 p-5 shadow-lg shadow-red-900/40 w-full">
        <div className="flex items-start gap-4">
          <div className="w-11 h-11 rounded-xl bg-red-900/60 flex items-center justify-center shrink-0">
    ...
    <div className="space-y-3 mb-6">
      ...
      <div
        className={cn(
          ...
          state.urgencyLevel === "final" || state.urgencyLevel === "shame"
            ? "border-red-300/40 dark:border-red-800/30 bg-red-50/30 dark:bg-red-950/10"
            : state.urgencyLevel === "critical"
              ? "border-red-200/40 dark:border-red-800/20 bg-red-50/20 dark:bg-red-950/5"
