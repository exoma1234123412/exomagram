...
type CelebrationType =
 |"day_complete"|"proof_100"|"streak_milestone"|"first_to_complete"|"title_promotion"|"buddy_duo_complete";
...
const KEYFRAMES_CSS =`@keyframes exo-confetti-burst {
 0% {
...
function DayCompleteCelebration() {
 ...
 <div
 className="font-bold tracking-tight"style={{
 fontSize: 28,
 ...
 <div
 className="text-muted-foreground font-medium"style={{
 fontSize: 14,
 marginTop: 4,
...
function StreakMilestoneCelebration({ days }: { days: number }) {
 ...
 >
 <div
 className="font-black tabular-nums"style={{
 fontSize: 56,
