  ...
  return (
    <>
      ...
      {duringWorkHours && (
        <div className="fixed bottom-4 left-4 z-[9998]">
          <button
            ...
            className={cn(
              "flex items-center gap-2 rounded-full px-3 py-1.5 text-xs font-medium shadow-lg backdrop-blur-sm transition-all duration-300",
          ...
          {showBreakdown && (
            <div
              className={cn(
                "absolute bottom-full left-0 mb-2 w-72 rounded-xl border border-border bg-background/95 p-4 shadow-2xl backdrop-blur-sm",
              )}
            >
      ...
      {stage === "gentle" && !dismissed && duringWorkHours && (
        <div
          className="fixed bottom-16 right-4 z-[9999] max-w-sm"
          style={{ animation: "inactivity-toast-in 0.3s ease-out" }}
        >
          <div
            className={cn(
              "flex items-center gap-3 rounded-xl border border-yellow-300/50 bg-yellow-50/95 px-4 py-3 shadow-lg backdrop-blur-sm",
      ...
      {stage === "alert" && duringWorkHours && (
        <>
          ...
          <div className="fixed inset-0 z-[9999] flex items-center justify-center pointer-events-none">
            <div
              className={cn(
                "pointer-events-auto rounded-2xl border-2 border-red-500/60 bg-red-950/90 px-8 py-6 shadow-2xl backdrop-blur-md",
            ...
            >
              ...
              <div
                className="text-3xl font-mono font-bold text-red-400 tabular-nums"
                style={{
      ...
      {stage === "escalation" && duringWorkHours && (
        ...
        >
          ...
          >
            {/* Skull icon */}
            <div className="mb-6">
              <Skull className="inline h-16 w-16 text-red-400 drop-shadow-lg" />
            </div>
            ...
            {/* Duration counter */}
            <div className="mb-6 inline-flex items-center gap-3 rounded-2xl border border-red-500/30 bg-red-900/50 px-6 py-4">
              <Clock className="h-6 w-6 text-red-400" />
              <div className="text-left">
                <p
                  className="text-3xl font-mono font-bold text-red-300 tabular-nums"
                  style={{
                    animation:
