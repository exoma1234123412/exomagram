...
"text-3xl font-black tabular-nums tracking-tight leading-none",
 stats.proofRate >= 70
 ?"text-green-600 dark:text-green-400": stats.proofRate >= 40
...
"p-4 border",
 ...
 ?"bg-green-50/50 dark:bg-green-950/10 border-green-200/60 dark:border-green-800/40": teamComparison.membersAhead >
 (teamComparison.totalMembers - 1) / 2
 ?"bg-red-50/50 dark:bg-red-950/10 border-red-200/60 dark:border-red-800/40":"bg-yellow-50/50 dark:bg-yellow-950/10 border-yellow-200/60 dark:border-yellow-800/40")}
 >
...
"font-bold tabular-nums text-sm",
 ...
 className={cn(
"p-4 border",
 trustProjection.direction ==="down"?"bg-red-50/50 dark:bg-red-950/10 border-red-200/60 dark:border-red-800/40": trustProjection.direction ==="up"?"bg-green-50/50 dark:bg-green-950/10 border-green-200/60 dark:border-green-800/40":"bg-accent/30 border-border")}
 >
 <h3 className="text-xs font-bold uppercase tracking-widest text-muted-foreground mb-2 flex items-center gap-1.5">
...
"h-full rounded-full transition-all duration-700",
 ...
 ?"bg-green-500": trustProjection.projectedScore >= 40
...
"p-4 border flex items-center gap-3",
 ...
 ?"bg-red-50/50 dark:bg-red-950/10 border-red-200/60 dark:border-red-800/40":"bg-orange-50/50 dark:bg-orange-950/10 border-orange-200/60 dark:border-orange-800/40")}
 >
 {streakInfo.willBreak ? (
 <>
...
"transition-all duration-300")}
 ...
 <div className="bg-red-50/60 dark:bg-red-950/10 border border-red-200/50 dark:border-red-800/30 p-3">
 ...
 <section className="flex items-center gap-3 p-4 bg-green-50/50 dark:bg-green-950/10 border border-green-200/60 dark:border-green-800/40">
 ...
 <section className="bg-accent/30 p-4 border border-border">
 <h3 className="text-xs font-bold uppercase tracking-widest text-muted-foreground mb-2 flex items-center gap-1.5">
 <Clock className="w-3.5 h-3.5"/>
 Mañana
 </h3>
...
"font-bold tabular-nums",
 ...
 <Button
 variant="ghost"size="sm"onClick={handleDismiss}
