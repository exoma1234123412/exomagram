...
"postgres_changes",
 ...
 <div className="w-8 h-8 bg-gradient-to-br from-amber-500 to-orange-600 animate-pulse"/>
...
"flex items-center gap-4 px-5 py-4 border-b transition-colors duration-300",
 completionMeterRed
 ?"bg-red-50 dark:bg-red-950/20 border-red-200 dark:border-red-800":"bg-accent/30 border-border/50")}
 >
 {/* Circular progress */}
 <div className="relative w-16 h-16 shrink-0">
 <svg
 className="-rotate-90 w-16 h-16"viewBox="0 0 72 72">
 <circle
 cx="36"cy="36"r={circleRadius}
 fill="none"stroke="currentColor"strokeWidth="5"className="text-muted/20"/>
 <circle
 cx="36"cy="36"r={circleRadius}
 fill="none"strokeWidth="5"className={cn(
 completionMeterRed
 ?"text-red-500": completionRatio >= 0.75
 ?"text-green-500": completionRatio >= 0.5
 ?"text-blue-500":"text-yellow-500")}
 stroke="currentColor"strokeDasharray={circleCircumference}
...
"text-xs mt-0.5",
 completionMeterRed
 ?"text-red-600 dark:text-red-400 font-medium":"text-muted-foreground")}
 >
 {completionMeterRed
 ?`Solo ${completionPercent}% completado despues de las 3pm`: completedCount === totalMembers
 ?"Todo el equipo completo":`${completedCount} de ${totalMembers} completaron sus ${EXPECTED_DAILY_HOURS}h`}
 </p>
 </div>
...
"text-[10px] font-bold tabular-nums w-10 text-right",
 row.isCompleted
 ?"text-green-600": row.hoursLogged >= EXPECTED_DAILY_HOURS * 0.5
 ?"text-foreground":"text-red-600")}
 >
...
"w-2.5 h-2.5 rounded-full",
 row.hoursLogged === 0
 ?"bg-gray-300 dark:bg-gray-600": proofGood
 ...
 {row.isCompleted ? (
 <Badge
 variant="outline"className="text-[9px] px-1.5 py-0 h-5 gap-0.5 text-green-700 dark:text-green-400 border-green-300 dark:border-green-700 bg-green-50 dark:bg-green-950/20">
 <CheckCircle2 className="w-3 h-3"/>
 Completado
 </Badge>
 ) : (
 <Badge
 variant="outline"className="text-[9px] px-1.5 py-0 h-5 gap-0.5 text-red-600 dark:text-red-400 border-red-300 dark:border-red-700 bg-red-50 dark:bg-red-950/20">
 ...
 {row.isIdle && (
 <Badge
 variant="outline"className="text-[9px] px-1.5 py-0 h-5 gap-0.5 text-yellow-700 dark:text-yellow-400 border-yellow-300 dark:border-yellow-700 bg-yellow-50 dark:bg-yellow-950/20">
 ...
 <Badge
 variant="outline"className="text-[9px] px-1.5 py-0 h-5 gap-0.5 text-gray-600 dark:text-gray-400 border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-950/20">
