...
"h-full rounded-full transition-all duration-500",
 ...
 <div className="w-8 h-8 bg-gradient-to-br from-blue-500 to-violet-600 animate-pulse"/>
...
"transition-all duration-300 hover:border-primary/30",
 ...
 {duoStreak > 0 && (
 <Badge
 variant="outline"className="text-[10px] px-2 py-0 h-5 gap-1 text-amber-700 dark:text-amber-400 border-amber-300 dark:border-amber-700 bg-amber-50 dark:bg-amber-950/20">
...
"text-lg font-bold tabular-nums",
 ...
 ?"text-green-600": sharedAccountabilityScore >= 60
 ...
 <div className="bg-destructive/5 border border-destructive/20 px-3 py-2 flex items-center gap-2">
 ...
 <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 px-3 py-2 space-y-1">
...
"")}
 ...
 {!showCheckin ? (
 <Button
 variant="outline"size="sm"className="text-xs gap-1.5"onClick={() => setShowCheckin(true)}
 >
 ...
 <Button
 variant="outline"size="sm"className="text-xs"onClick={() => handleSendMessage("como_vas")}
 >
 ¿Cómo vas hoy?
 </Button>
 <Button
 variant="outline"size="sm"className="text-xs"onClick={() => handleSendMessage("animo")}
 >
 ¡Ánimo!
 </Button>
 <div className="flex gap-1 flex-1 min-w-[160px]">
 <input
 type="text"placeholder="Mensaje personalizado..."value={customMessage}
 ...
 className="flex-1 text-xs border border-input bg-background px-3 py-1.5 focus:outline-none focus:ring-1 focus:ring-ring"/>
 <Button
 variant="default"size="sm"className="text-xs"disabled={!customMessage.trim()}
 ...
 <Button
 variant="ghost"size="sm"className="text-xs text-muted-foreground"onClick={() => setShowCheckin(false)}
 >
 Cancelar
 </Button>
 </div>
 ...
 {/* ── Change buddy ─────────────────────────────── */}
 <Button
 variant="ghost"size="sm"className="text-xs text-muted-foreground gap-1"disabled={!canChangeBuddy(pairing) || changingBuddy}
 onClick={handleChangeBuddy}
 title={
 canChangeBuddy(pairing)
 ?"Solicitar nuevo buddy":`Podrás cambiar en ${daysUntilChange(pairing)} días`}
 >
 <RefreshCw
 className={cn(
"w-3.5 h-3.5",
 ...
 />
 {canChangeBuddy(pairing)
 ?"Cambiar buddy":`Bloqueado ${daysUntilChange(pairing)}d`}
 </Button>
 </CardFooter>
 </Card>
...
"text-sm font-bold tabular-nums",
 ...
 ?"text-green-600": pair.combinedScore >= 60
 ?"text-yellow-600":"text-red-600")}
 >
 {pair.combinedScore}
 </span>
