...
// - BetterThanYou:"X personas tienen mejor ... que tu"// - ProgressToAverage: micro progress bar showing distance to avg
...
export function ComparisonTooltip({
 ...
 <TooltipContent
 side="top"className="max-w-xs p-0 bg-popover text-popover-foreground border overflow-hidden">
...
"font-bold",
 ...
 {/* Average marker */}
 <div
 className="absolute top-0 h-full w-px bg-muted-foreground/50"style={{ left:`${avgPct}%`}}
 />
 {/* Your position dot */}
 <div
 className={cn(
...
,
 ...
 <TooltipContent
 side="bottom"className="max-w-xs bg-popover text-popover-foreground border">
...
export function ProgressToAverage({
 ...
 {/* Your filled portion */}
 <div
 className="absolute inset-y-0 left-0 rounded-full bg-foreground/20"style={{ width:`${valuePct}%`}}
 />
...
"absolute top-1/2 -translate-y-1/2 w-2 h-2 rounded-full border border-background",
 ...
 {/* Average marker line */}
 <div
 className="absolute inset-y-0 w-px bg-muted-foreground/60"style={{ left:`${avgPct}%`}}
 />
 </div>
...
"font-bold",
 ...
 {data.bestName && (
 <TooltipContent
 side="bottom"className="bg-popover text-popover-foreground border">
 <p className="text-xs">
...
"text-[9px] tabular-nums flex items-center gap-0.5 mt-0.5",
 isBelow
 ?"text-muted-foreground/60":"text-green-600/60 dark:text-green-400/60")}
 >
...
"text-[9px] px-1.5 py-0 h-4 gap-0.5 font-medium tabular-nums",
 isAbove
 ?"text-green-700 dark:text-green-400 border-green-300 dark:border-green-700 bg-green-50 dark:bg-green-950/20":"text-red-700 dark:text-red-400 border-red-300 dark:border-red-700 bg-red-50 dark:bg-red-950/20")}
 >
