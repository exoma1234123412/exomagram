    ...
    <TooltipProvider>
      <div className="fixed bottom-4 right-4 z-50">
        <Tooltip>
          <TooltipTrigger
            className={cn(
              "flex items-center gap-2 rounded-full px-3 py-2 text-xs font-medium shadow-lg backdrop-blur-sm",
              "border transition-all duration-300 cursor-default select-none",
              showIdleWarning
                ? "border-red-300/60 bg-red-50/90 text-red-700 dark:border-red-700/50 dark:bg-red-950/80 dark:text-red-300"
                : "border-border/60 bg-card/90 text-foreground dark:bg-card/80",
            )}
          >
            {/* Pulse dot */}
            ...
            <span
              className={cn(
                ...
                showIdleWarning
                  ? "bg-red-200/60 text-red-800 dark:bg-red-800/40 dark:text-red-200"
