  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent
        ...
        className="sm:max-w-2xl max-h-[95vh] overflow-y-auto rounded-2xl p-0"
      >
        {/* ── Verdict Header ─────────────────────────────────── */}
        <div
          className={cn(
        ...
        <form onSubmit={handleSubmit} className="px-6 py-5 space-y-6">
          ...
          <section>
                ...
                <p
                  className={cn(
                    ...
                    weekStats.totalHours >= EXPECTED_WEEKLY_HOURS * 0.9
                      ...
                      : weekStats.totalHours >= EXPECTED_WEEKLY_HOURS * 0.7
            ...
            {weekStats.currentStreak > 0 && (
              <div
                className={cn(
                  "mt-3 flex items-center gap-2 rounded-xl p-3 border",
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex-1 h-3 bg-accent/60 rounded-full overflow-hidden">
                        <div
                          className="h-full rounded-full transition-all duration-700 bg-blue-500"
                          style={{ width: `${teamComparison.teamProofRate}%` }}
                        />
                      </div>
                    </div>
                  </div>
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  placeholder="Describe tu logro principal con detalle..."
                  value={form.mayorLogro}
                  onChange={(e) => {
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  placeholder="Sé honesto. ¿Dónde fallaste o podrías haber dado más?"
                  value={form.mejorHecho}
                  onChange={(e) => {
              ...
              {weekStats.totalGapHours > 0 && (
                <div className="space-y-2">
                  ...
                  <Textarea
                    placeholder="Explica cada bloque de tiempo sin registro..."
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  placeholder="Compromisos concretos para la próxima semana..."
                  value={form.diferente}
                  onChange={(e) => {
                ...
                <div className="flex gap-2">
                  {[1, 2, 3, 4, 5].map((level) => (
                    <button
                      ...
                      className={cn(
                        "flex-1 py-3 rounded-xl text-sm font-semibold transition-all duration-200 flex flex-col items-center gap-1",
          ...
          {/* ══ Visibility warning ═══════════════════════════════ */}
          <div className="bg-yellow-50/80 dark:bg-yellow-950/15 border border-yellow-200/60 dark:border-yellow-800/40 rounded-xl p-3.5 flex items-start gap-2.5">
