...
export function CrossVerifyDialog({ entry, open, onOpenChange }: CrossVerifyProps) {
 ...
 className={cn(
"w-full flex items-center gap-3 p-2.5 border-2 transition-all text-left",
 existingStatus
 ?"border-transparent bg-muted/30 cursor-default": isSelected
 ?"border-blue-500 bg-blue-50 dark:bg-blue-950/20":"border-transparent bg-muted/50 hover:bg-muted")}
 >
