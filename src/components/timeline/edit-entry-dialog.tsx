...
export function EditEntryDialog({ entry, open, onOpenChange, onSaved }: EditEntryDialogProps) {
 ...
 className={cn(
"flex flex-col items-center gap-1.5 p-2.5 border-2 text-xs font-semibold transition-all duration-200",
 category === key
 ...
 <Textarea
 id="edit-desc"value={description}
