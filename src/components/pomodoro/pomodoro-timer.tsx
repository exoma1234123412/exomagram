...
"transition-all",
 ...
 <circle cx="60"cy="60"r="54"fill="none"strokeWidth="8"className={cn(
 ...
 <Input
 placeholder="¿En qué vas a trabajar?"value={taskTitle}
 ...
 size="sm"onClick={() => { setDuration(d); setTimeLeft(d * 60); }}
 >
 {d}m
 </Button>
 ))}
 ...
 <div className="flex items-center justify-center gap-2">
 {!isRunning && !completed && (
 <Button onClick={startTimer} disabled={!taskTitle.trim()} className="gap-2 bg-primary hover:from-blue-700 hover:to-blue-800 text-white border-0">
