            ...
            <>
              ...
              <div className="text-center mb-3">
                <div className={cn(
                  ...
                  timeLeft > 90 ? "bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400"
                  : timeLeft > 30 ? "bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400"
