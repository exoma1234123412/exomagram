...
// At random times, a popup asks"¿Qué estás haciendo AHORA MISMO?"// You have 5 minutes to respond. If you don't respond, it's flagged.
...
"inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-sm font-mono font-bold",
 timeLeft > 120 ?"bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400": timeLeft > 60 ?"bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400":"bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400 animate-pulse")}>
 ...
 <Textarea
 placeholder="Estoy trabajando en..."value={response}
