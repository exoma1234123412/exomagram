...
export function DecayScoreWarning({ score, hasStandup, hasCloseout, hoursLogged, proofPercent }: {
  ...
  return (
    <div className={cn(
      ...
      netChange <= -5 ? "bg-red-50 dark:bg-red-950/15 border-red-200 dark:border-red-800"
      : netChange < 0 ? "bg-yellow-50 dark:bg-yellow-950/15 border-yellow-200 dark:border-yellow-800"
      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          <p className={cn(
            ...
            netChange <= -5 ? "text-red-700 dark:text-red-400"
            : netChange < 0 ? "text-yellow-700 dark:text-yellow-400"
            : "text-green-700 dark:text-green-400"
          )}>
            {netChange < 0
              ? `Tu score caerá ${Math.abs(netChange)} puntos mañana`
              : `Tu score subirá ${netChange} puntos`}
          </p>
