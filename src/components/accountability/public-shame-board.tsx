...
"flex items-center gap-3 px-4 py-3 border transition-all",
 entry.severity ==="critical"?"bg-red-50 dark:bg-red-950/15 border-red-200 dark:border-red-800 animate-pulse":"bg-yellow-50 dark:bg-yellow-950/10 border-yellow-200 dark:border-yellow-800")}
 >
