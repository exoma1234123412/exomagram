...
// "What did you accomplish in the last 30 minutes?"
// This forces real granularity. You can't fake 16 detailed check-ins per day.
          ...
          {submitted ? (
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                <Input
                  placeholder="Terminé la validación del formulario de pagos..."
                  value={response}
