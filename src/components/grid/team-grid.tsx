...
"postgres_changes",
 ...
 return (
 <TooltipProvider>
 <div className="overflow-x-auto bg-card border border-border/50 p-5">
 ...
 <div
 key={hour}
 className="grid gap-1.5 mb-1.5"style={{ gridTemplateColumns:`72px repeat(${members.length}, 1fr)`}}
 >
 {/* Hour label */}
 ...
 <TooltipTrigger
 className={cn(
"h-11 transition-all duration-200 cursor-default w-full",
 entry
 ? cn(
"bg-gradient-to-br",
 gradient,
