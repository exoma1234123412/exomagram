...
export function MemberList({
  ...
  return (
    <div className="space-y-6">
      {/* Stats bar */}
      <div className="bg-card/80 border border-border/40 rounded-2xl p-5 shadow-sm">
      ...
      {/* Member list */}
      <div className="bg-card/80 border border-border/40 rounded-2xl shadow-sm overflow-hidden">
              ...
              >
                  ...
                  <div className="min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      {isSelf && (
                        <Badge
                          variant="outline"
                          className="text-[9px] rounded-md px-1.5"
                        >
                          Tú
                        </Badge>
                      )}
                ...
                <div className="flex items-center gap-3 shrink-0">
                  ...
                  <div className="text-right hidden sm:block">
                    ...
                    <p className="text-[10px] text-muted-foreground/40 flex items-center gap-1 justify-end">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      >
                        <SelectTrigger
                          size="sm"
                          className={cn(
                            "rounded-lg text-[11px] h-7 w-auto min-w-[90px]",
      ...
      {pendingInvitations.length > 0 && (
        <div className="bg-card/80 border border-border/40 rounded-2xl shadow-sm overflow-hidden">
          <div className="px-5 py-4 border-b border-border/30 flex items-center justify-between">
            ...
            <Badge
              variant="secondary"
              className="text-[10px] rounded-md font-semibold"
            >
            ...
            {pendingInvitations.map((inv) => {
              ...
              return (
                ...
                >
                  ...
                  <Badge
                    variant="outline"
                    className="text-[10px] rounded-md text-amber-600 border-amber-300/50 bg-amber-50/50 dark:bg-amber-950/20"
                  >
                    Pendiente
                  </Badge>
                </div>
