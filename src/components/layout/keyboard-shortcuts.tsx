...
export function KeyboardShortcuts({ onNewEntry }: KeyboardShortcutsProps) {
 ...
 {/* Command palette */}
 <div className="relative w-full max-w-lg bg-background/95 glass border border-border/50 shadow-2xl shadow-primary/10 overflow-hidden animate-in fade-in slide-in-from-top-4 duration-200">
 <div className="flex items-center gap-3 px-4 py-3.5 border-b border-border/50">
 <Search className="w-4 h-4 text-muted-foreground"/>
 <input
 value={query}
 onChange={(e) => handleInput(e.target.value)}
 placeholder="Buscar entradas, paginas..."className="flex-1 bg-transparent outline-none text-sm placeholder:text-muted-foreground"autoFocus
 />
 ...
 className="w-full flex items-center gap-3 px-3 py-2 text-sm hover:bg-accent/60 transition-all duration-150 text-left group/cmd">
 ...
 <div className="flex items-center gap-4 px-4 py-2.5 border-t border-border/50 bg-muted/30 text-[10px] text-muted-foreground">
 <span className="flex items-center gap-1.5">
 <kbd className="bg-background/80 border border-border/50 px-1.5 py-0.5 rounded-md font-mono text-[9px]">
