        ...
        <div className="md:hidden fixed inset-0 z-[60] bg-background bg-grid-dense">
          ...
          <div className="overflow-y-auto h-[calc(100vh-120px)] px-4 py-3 space-y-4">
            {menuSections.map((section, sectionIdx) => (
              <div key={sectionIdx}>
                {section.label && (
                  <p className="font-mono text-[9px] font-semibold tracking-[0.18em] text-muted-foreground/40 mb-2 px-1">
                    {section.label}
                  </p>
                )}
          ...
          <div className="absolute bottom-0 left-0 right-0 p-3 border-t border-border/40 bg-background safe-area-pb">
            <button
              ...
              className="flex items-center gap-2.5 w-full px-3 py-2 text-[10px] font-mono tracking-wide uppercase text-muted-foreground/40 hover:text-muted-foreground hover:bg-accent/30 transition-colors"
            >
