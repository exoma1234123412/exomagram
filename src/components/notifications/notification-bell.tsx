...
export function NotificationBell() {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className="relative inline-flex items-center justify-center h-9 w-9 rounded-xl hover:bg-accent transition-colors">
      ...
      <DropdownMenuContent align="end" className="w-80 max-h-96 overflow-y-auto rounded-2xl border-border/50 shadow-xl">
